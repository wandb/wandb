...
func TestExponentialBackoffWithJitter_NonHTTP429(t *testing.T) {
	...
	backoff := retryableclient.ExponentialBackoffWithJitter(min, max, attemptNum, nil)
...
func TestExponentialBackoffWithJitter_HTTP429(t *testing.T) {
	...
	backoff := retryableclient.ExponentialBackoffWithJitter(min, max, attemptNum, resp)
