...
func NewWatcher(logger *observability.CoreLogger, outChan chan *service.Record) *Watcherr {
	return &Watcherr{
		watcher: fw.New(),
...
func (w *Watcherr) Add(path string) error {
