...
// DumpRecords writes every record in the .wandb file at path to w as
// prototext, each preceded by a "# record N: <type>" line.
//
...
func DumpRecords(path string, w io.Writer) error {
