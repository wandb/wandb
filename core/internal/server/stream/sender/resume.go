...
func (r *ResumeState) updateHistory(run *pb.RunRecord, bucket *Bucket) (*pb.RunUpdateResult, error) {
...
func (r *ResumeState) updateSummary(run *pb.RunRecord, bucket *Bucket) (*pb.RunUpdateResult, error) {
...
func (r *ResumeState) updateConfig(bucket *Bucket, config map[string]interface{}) (*pb.RunUpdateResult, error) {
...
func (r *ResumeState) updateTags(run *pb.RunRecord, bucket *Bucket) {
	// handle tags
