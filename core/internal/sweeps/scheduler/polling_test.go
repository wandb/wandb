...
func TestExhaustedSearchSpace(t *testing.T) {
	...
	t.Run("waits for an enqueued run the poll cannot see yet", func(t *testing.T) {
...
func TestPrune(t *testing.T) {
	...
	t.Run("ignores an id that was never a candidate", func(t *testing.T) {
		fixture := newLoopFixture(t, scheduler.SchedulerParams{})
		fixture.warmTo(t)
		fixture.stubIdlePoll("RUNNING")
		fixture.step(t, warmResult(nil))
...
// An enqueue that failed scheduled no run, so the suggestion is
// discarded for the optimizer to release. Only a rate limit is worth
// another pass.
func TestEnqueueFailures(t *testing.T) {
	...
	t.Run("a fatal failure ends the scheduler with the discard", func(t *testing.T) {
		fixture := newLoopFixture(t, scheduler.SchedulerParams{BatchSize: 2})
		fixture.warmTo(t)
		fixture.stubIdlePoll("RUNNING")
		fixture.step(t, warmResult(nil))
	...
	t.Run("the suggestions behind a fatal failure are discarded too", func(t *testing.T) {
...
// A suggestion the scheduler cannot join to a run of its own is
...
func TestUnusableSuggestionIdsAreDroppedWithoutDiscarding(t *testing.T) {
	t.Run("an id already in use", func(t *testing.T) {
		fixture := newLoopFixture(t, scheduler.SchedulerParams{BatchSize: 2})
		fixture.warmTo(t)
		fixture.stubPoll(pollJSON("RUNNING", false, "",
			testRun{name: "run-1", state: "running"},
	...
	t.Run("an empty id", func(t *testing.T) {
		fixture := newLoopFixture(t, scheduler.SchedulerParams{BatchSize: 2})
		fixture.warmTo(t)
		fixture.stubIdlePoll("RUNNING")
		fixture.step(t, warmResult(nil))
