...
func (x *TFEvent) Reset() {
	*x = TFEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tfevent_proto_msgTypes[0]
...
func (*TFEvent) Descriptor() ([]byte, []int) {
	return file_tfevent_proto_rawDescGZIP(), []int{0}
}
...
func (x *Summary) Reset() {
	*x = Summary{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tfevent_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Summary) Descriptor() ([]byte, []int) {
	return file_tfevent_proto_rawDescGZIP(), []int{1}
}
...
func (x *SummaryMetadata) Reset() {
	*x = SummaryMetadata{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tfevent_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SummaryMetadata) Descriptor() ([]byte, []int) {
	return file_tfevent_proto_rawDescGZIP(), []int{2}
}
...
func (x *TensorProto) Reset() {
	*x = TensorProto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tfevent_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TensorProto) Descriptor() ([]byte, []int) {
	return file_tfevent_proto_rawDescGZIP(), []int{3}
}
...
func (x *Summary_Value) Reset() {
	*x = Summary_Value{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tfevent_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Summary_Value) Descriptor() ([]byte, []int) {
	return file_tfevent_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *SummaryMetadata_PluginData) Reset() {
	*x = SummaryMetadata_PluginData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_tfevent_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SummaryMetadata_PluginData) Descriptor() ([]byte, []int) {
	return file_tfevent_proto_rawDescGZIP(), []int{2, 0}
}
...
var File_tfevent_proto protoreflect.FileDescriptor

var file_tfevent_proto_rawDesc = []byte{
	,
...
var (
	file_tfevent_proto_rawDescOnce sync.Once
	file_tfevent_proto_rawDescData = file_tfevent_proto_rawDesc
)

func file_tfevent_proto_rawDescGZIP() []byte {
	file_tfevent_proto_rawDescOnce.Do(func() {
		file_tfevent_proto_rawDescData = protoimpl.X.CompressGZIP(file_tfevent_proto_rawDescData)
	})
	return file_tfevent_proto_rawDescData
}

var file_tfevent_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_tfevent_proto_goTypes = []interface{}{
	(*TFEvent)(nil),                    // 0: TFEvent
	(*Summary)(nil),                    // 1: Summary
	(*SummaryMetadata)(nil),            // 2: SummaryMetadata
	(*TensorProto)(nil),                // 3: TensorProto
	(*Summary_Value)(nil),              // 4: Summary.Value
	(*SummaryMetadata_PluginData)(nil), // 5: SummaryMetadata.PluginData
}
var file_tfevent_proto_depIdxs = []int32{
	...
	3, // 4: Summary.Value.tensor:type_name -> TensorProto
...
func init() { file_tfevent_proto_init() }
func file_tfevent_proto_init() {
	if File_tfevent_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_tfevent_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tfevent_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tfevent_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tfevent_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tfevent_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tfevent_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_tfevent_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*TFEvent_Summary)(nil),
	}
	file_tfevent_proto_msgTypes[4].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_tfevent_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_tfevent_proto_goTypes,
		DependencyIndexes: file_tfevent_proto_depIdxs,
		MessageInfos:      file_tfevent_proto_msgTypes,
	}.Build()
	File_tfevent_proto = out.File
	file_tfevent_proto_rawDesc = nil
	file_tfevent_proto_goTypes = nil
	file_tfevent_proto_depIdxs = nil
}
