...
type RunLogRequest_Level int32

const (
	RunLogRequest_INFO  RunLogRequest_Level = 0
	RunLogRequest_ERROR RunLogRequest_Level = 1
)

// Enum value maps for RunLogRequest_Level.
var (
	RunLogRequest_Level_name = map[int32]string{
		0: "INFO",
		1: "ERROR",
	}
	RunLogRequest_Level_value = map[string]int32{
		"INFO":  0,
		"ERROR": 1,
	}
)

func (x RunLogRequest_Level) Enum() *RunLogRequest_Level {
	p := new(RunLogRequest_Level)
	*p = x
	return p
}

func (x RunLogRequest_Level) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RunLogRequest_Level) Descriptor() protoreflect.EnumDescriptor {
	return file_wandb_proto_wandb_internal_proto_enumTypes[10].Descriptor()
}

func (RunLogRequest_Level) Type() protoreflect.EnumType {
	return &file_wandb_proto_wandb_internal_proto_enumTypes[10]
}

func (x RunLogRequest_Level) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RunLogRequest_Level.Descriptor instead.
func (RunLogRequest_Level) EnumDescriptor() ([]byte, []int) {
	return file_wandb_proto_wandb_internal_proto_rawDescGZIP(), []int{112, 0}
}
...
func (x *Request) GetRunLog() *RunLogRequest {
	if x != nil {
		if x, ok := x.RequestType.(*Request_RunLog); ok {
			return x.RunLog
		}
	}
	return nil
...
type Request_RunLog struct {
	RunLog *RunLogRequest `protobuf:"bytes,85,opt,name=run_log,json=runLog,proto3,oneof"`
}
...
func (*Request_RunLog) isRequest_RequestType() {}
...
// RunLogRequest: one finished line of a run's logs.
//
// Unlike console output, the line is complete when it is sent and is
// never revised, so it is uploaded once and appended to the run's log.
// This suits a run whose log lines are numbered by the server, such as
// a sweep's controller run: there, an update revising an earlier line
// is stored as a new line rather than replacing it. Such a run must
// not also capture console output, whose lines are numbered by the
// client and revised in place.
//
// This is a request rather than a record because the lines describe a
// session watching the run, not the run itself: replaying them from a
// transaction log would append them a second time.
type RunLogRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The line's text, without a trailing newline.
	Line string `protobuf:"bytes,1,opt,name=line,proto3" json:"line,omitempty"`
	// Identifies the writer of the line, displayed alongside it.
	//
	// Unlike the run's x_label setting, which names one writer for a
	// whole run, this distinguishes lines a single writer relays on
	// behalf of several sources.
	Label string `protobuf:"bytes,2,opt,name=label,proto3" json:"label,omitempty"`
	// The line's severity.
	Level         RunLogRequest_Level `protobuf:"varint,3,opt,name=level,proto3,enum=wandb_internal.RunLogRequest_Level" json:"level,omitempty"`
	XInfo         *XRequestInfo       `protobuf:"bytes,200,opt,name=_info,json=Info,proto3" json:"_info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RunLogRequest) GetLine() string {
	if x != nil {
		return x.Line
	}
	return ""
...
func (x *RunLogRequest) GetLabel() string {
	if x != nil {
		return x.Label
	}
	return ""
...
func (x *RunLogRequest) GetLevel() RunLogRequest_Level {
	if x != nil {
		return x.Level
	}
	return RunLogRequest_INFO
}

func (x *RunLogRequest) GetXInfo() *XRequestInfo {
	if x != nil {
		return x.XInfo
	}
	return nil
...
const file_wandb_proto_wandb_internal_proto_rawDesc = "" +
	...
	"syncFinish\x128\n" +
	"\arun_log\x18U \x01(\v2\x1d.wandb_internal.RunLogRequestH\x00R\x06runLog\x12G\n" +
	"\n" +
	...
	"\x16PartialHistoryResponse\"\xc6\x01\n" +
	"\rRunLogRequest\x12\x12\n" +
	"\x04line\x18\x01 \x01(\tR\x04line\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x129\n" +
	"\x05level\x18\x03 \x01(\x0e2#.wandb_internal.RunLogRequest.LevelR\x05level\x122\n" +
	"\x05_info\x18\xc8\x01 \x01(\v2\x1c.wandb_internal._RequestInfoR\x04Info\"\x1c\n" +
	"\x05Level\x12\b\n" +
	"\x04INFO\x10\x00\x12\t\n" +
	"\x05ERROR\x10\x01\"\x14\n" +
...
var file_wandb_proto_wandb_internal_proto_goTypes = []any{
	...
	(RunLogRequest_Level)(0),                    // 10: wandb_internal.RunLogRequest.Level
	...
	(*RunLogRequest)(nil),                       // 123: wandb_internal.RunLogRequest
...
var file_wandb_proto_wandb_internal_proto_depIdxs = []int32{
	...
	179, // 58: wandb_internal.OutputRecord.timestamp:type_name -> google.protobuf.Timestamp
	177, // 59: wandb_internal.OutputRecord._info:type_name -> wandb_internal._RecordInfo
	3,   // 60: wandb_internal.OutputRawRecord.output_type:type_name -> wandb_internal.OutputRawRecord.OutputType
	179, // 61: wandb_internal.OutputRawRecord.timestamp:type_name -> google.protobuf.Timestamp
	177, // 62: wandb_internal.OutputRawRecord._info:type_name -> wandb_internal._RecordInfo
	40,  // 63: wandb_internal.MetricRecord.options:type_name -> wandb_internal.MetricOptions
	42,  // 64: wandb_internal.MetricRecord.summary:type_name -> wandb_internal.MetricSummary
	4,   // 65: wandb_internal.MetricRecord.goal:type_name -> wandb_internal.MetricRecord.MetricGoal
	41,  // 66: wandb_internal.MetricRecord._control:type_name -> wandb_internal.MetricControl
	177, // 67: wandb_internal.MetricRecord._info:type_name -> wandb_internal._RecordInfo
	44,  // 68: wandb_internal.ConfigRecord.update:type_name -> wandb_internal.ConfigItem
	44,  // 69: wandb_internal.ConfigRecord.remove:type_name -> wandb_internal.ConfigItem
	177, // 70: wandb_internal.ConfigRecord._info:type_name -> wandb_internal._RecordInfo
	47,  // 71: wandb_internal.SummaryRecord.update:type_name -> wandb_internal.SummaryItem
	47,  // 72: wandb_internal.SummaryRecord.remove:type_name -> wandb_internal.SummaryItem
	177, // 73: wandb_internal.SummaryRecord._info:type_name -> wandb_internal._RecordInfo
	50,  // 74: wandb_internal.FilesRecord.files:type_name -> wandb_internal.FilesItem
	177, // 75: wandb_internal.FilesRecord._info:type_name -> wandb_internal._RecordInfo
	...
	179, // 79: wandb_internal.StatsRecord.timestamp:type_name -> google.protobuf.Timestamp
	53,  // 80: wandb_internal.StatsRecord.item:type_name -> wandb_internal.StatsItem
	177, // 81: wandb_internal.StatsRecord._info:type_name -> wandb_internal._RecordInfo
	55,  // 82: wandb_internal.ArtifactRecord.manifest:type_name -> wandb_internal.ArtifactManifest
	177, // 83: wandb_internal.ArtifactRecord._info:type_name -> wandb_internal._RecordInfo
	58,  // 84: wandb_internal.ArtifactManifest.storage_policy_config:type_name -> wandb_internal.StoragePolicyConfigItem
	56,  // 85: wandb_internal.ArtifactManifest.contents:type_name -> wandb_internal.ArtifactManifestEntry
	57,  // 86: wandb_internal.ArtifactManifestEntry.extra:type_name -> wandb_internal.ExtraItem
	177, // 87: wandb_internal.LinkArtifactRequest._info:type_name -> wandb_internal._RecordInfo
	177, // 88: wandb_internal.TBRecord._info:type_name -> wandb_internal._RecordInfo
	177, // 89: wandb_internal.AlertRecord._info:type_name -> wandb_internal._RecordInfo
	84,  // 90: wandb_internal.Request.stop_status:type_name -> wandb_internal.StopStatusRequest
	86,  // 91: wandb_internal.Request.network_status:type_name -> wandb_internal.NetworkStatusRequest
	69,  // 92: wandb_internal.Request.defer:type_name -> wandb_internal.DeferRequest
	76,  // 93: wandb_internal.Request.get_summary:type_name -> wandb_internal.GetSummaryRequest
	74,  // 94: wandb_internal.Request.login:type_name -> wandb_internal.LoginRequest
	70,  // 95: wandb_internal.Request.pause:type_name -> wandb_internal.PauseRequest
	72,  // 96: wandb_internal.Request.resume:type_name -> wandb_internal.ResumeRequest
	92,  // 97: wandb_internal.Request.poll_exit:type_name -> wandb_internal.PollExitRequest
	126, // 98: wandb_internal.Request.sampled_history:type_name -> wandb_internal.SampledHistoryRequest
	121, // 99: wandb_internal.Request.partial_history:type_name -> wandb_internal.PartialHistoryRequest
	124, // 100: wandb_internal.Request.history_step:type_name -> wandb_internal.HistoryStepRequest
	131, // 101: wandb_internal.Request.run_start:type_name -> wandb_internal.RunStartRequest
	133, // 102: wandb_internal.Request.check_version:type_name -> wandb_internal.CheckVersionRequest
	137, // 103: wandb_internal.Request.log_artifact:type_name -> wandb_internal.LogArtifactRequest
	139, // 104: wandb_internal.Request.download_artifact:type_name -> wandb_internal.DownloadArtifactRequest
	141, // 105: wandb_internal.Request.keepalive:type_name -> wandb_internal.KeepaliveRequest
	129, // 106: wandb_internal.Request.run_status:type_name -> wandb_internal.RunStatusRequest
	152, // 107: wandb_internal.Request.cancel:type_name -> wandb_internal.CancelRequest
	89,  // 108: wandb_internal.Request.internal_messages:type_name -> wandb_internal.InternalMessagesRequest
	165, // 109: wandb_internal.Request.python_packages:type_name -> wandb_internal.PythonPackagesRequest
	114, // 110: wandb_internal.Request.shutdown:type_name -> wandb_internal.ShutdownRequest
	116, // 111: wandb_internal.Request.attach:type_name -> wandb_internal.AttachRequest
	82,  // 112: wandb_internal.Request.status:type_name -> wandb_internal.StatusRequest
	105, // 113: wandb_internal.Request.server_info:type_name -> wandb_internal.ServerInfoRequest
	98,  // 114: wandb_internal.Request.sender_mark:type_name -> wandb_internal.SenderMarkRequest
	101, // 115: wandb_internal.Request.sender_read:type_name -> wandb_internal.SenderReadRequest
	102, // 116: wandb_internal.Request.status_report:type_name -> wandb_internal.StatusReportRequest
	103, // 117: wandb_internal.Request.summary_record:type_name -> wandb_internal.SummaryRecordRequest
	104, // 118: wandb_internal.Request.telemetry_record:type_name -> wandb_internal.TelemetryRecordRequest
	135, // 119: wandb_internal.Request.job_info:type_name -> wandb_internal.JobInfoRequest
	78,  // 120: wandb_internal.Request.get_system_metrics:type_name -> wandb_internal.GetSystemMetricsRequest
	168, // 121: wandb_internal.Request.job_input:type_name -> wandb_internal.JobInputRequest
	61,  // 122: wandb_internal.Request.link_artifact:type_name -> wandb_internal.LinkArtifactRequest
	99,  // 123: wandb_internal.Request.sync_finish:type_name -> wandb_internal.SyncFinishRequest
	123, // 124: wandb_internal.Request.run_log:type_name -> wandb_internal.RunLogRequest
	94,  // 125: wandb_internal.Request.operations:type_name -> wandb_internal.OperationStatsRequest
	154, // 126: wandb_internal.Request.probe_system_info:type_name -> wandb_internal.ProbeSystemInfoRequest
	...
	128, // 134: wandb_internal.Response.sampled_history_response:type_name -> wandb_internal.SampledHistoryResponse
	125, // 135: wandb_internal.Response.history_step_response:type_name -> wandb_internal.HistoryStepResponse
	132, // 136: wandb_internal.Response.run_start_response:type_name -> wandb_internal.RunStartResponse
	134, // 137: wandb_internal.Response.check_version_response:type_name -> wandb_internal.CheckVersionResponse
	138, // 138: wandb_internal.Response.log_artifact_response:type_name -> wandb_internal.LogArtifactResponse
	140, // 139: wandb_internal.Response.download_artifact_response:type_name -> wandb_internal.DownloadArtifactResponse
	130, // 140: wandb_internal.Response.run_status_response:type_name -> wandb_internal.RunStatusResponse
	153, // 141: wandb_internal.Response.cancel_response:type_name -> wandb_internal.CancelResponse
	90,  // 142: wandb_internal.Response.internal_messages_response:type_name -> wandb_internal.InternalMessagesResponse
	115, // 143: wandb_internal.Response.shutdown_response:type_name -> wandb_internal.ShutdownResponse
	117, // 144: wandb_internal.Response.attach_response:type_name -> wandb_internal.AttachResponse
	83,  // 145: wandb_internal.Response.status_response:type_name -> wandb_internal.StatusResponse
	106, // 146: wandb_internal.Response.server_info_response:type_name -> wandb_internal.ServerInfoResponse
	136, // 147: wandb_internal.Response.job_info_response:type_name -> wandb_internal.JobInfoResponse
	81,  // 148: wandb_internal.Response.get_system_metrics_response:type_name -> wandb_internal.GetSystemMetricsResponse
	62,  // 149: wandb_internal.Response.link_artifact_response:type_name -> wandb_internal.LinkArtifactResponse
	100, // 150: wandb_internal.Response.sync_response:type_name -> wandb_internal.SyncResponse
	95,  // 151: wandb_internal.Response.operations_response:type_name -> wandb_internal.OperationStatsResponse
	119, // 152: wandb_internal.Response.test_inject_response:type_name -> wandb_internal.TestInjectResponse
	...
	47,  // 158: wandb_internal.GetSummaryResponse.item:type_name -> wandb_internal.SummaryItem
	...
	79,  // 161: wandb_internal.SystemMetricsBuffer.record:type_name -> wandb_internal.SystemMetricSample
	...
	88,  // 166: wandb_internal.NetworkStatusResponse.network_responses:type_name -> wandb_internal.HttpResponse
	180, // 167: wandb_internal.InternalMessagesRequest._info:type_name -> wandb_internal._RequestInfo
	91,  // 168: wandb_internal.InternalMessagesResponse.messages:type_name -> wandb_internal.InternalMessages
	180, // 169: wandb_internal.PollExitRequest._info:type_name -> wandb_internal._RequestInfo
	24,  // 170: wandb_internal.PollExitResponse.exit_result:type_name -> wandb_internal.RunExitResult
	110, // 171: wandb_internal.PollExitResponse.pusher_stats:type_name -> wandb_internal.FilePusherStats
	109, // 172: wandb_internal.PollExitResponse.file_counts:type_name -> wandb_internal.FileCounts
	96,  // 173: wandb_internal.PollExitResponse.operation_stats:type_name -> wandb_internal.OperationStats
	180, // 174: wandb_internal.OperationStatsRequest._info:type_name -> wandb_internal._RequestInfo
	96,  // 175: wandb_internal.OperationStatsResponse.operation_stats:type_name -> wandb_internal.OperationStats
	97,  // 176: wandb_internal.OperationStats.operations:type_name -> wandb_internal.Operation
	97,  // 177: wandb_internal.Operation.subtasks:type_name -> wandb_internal.Operation
	22,  // 178: wandb_internal.SyncResponse.error:type_name -> wandb_internal.ErrorInfo
	179, // 179: wandb_internal.StatusReportRequest.sync_time:type_name -> google.protobuf.Timestamp
	46,  // 180: wandb_internal.SummaryRecordRequest.summary:type_name -> wandb_internal.SummaryRecord
	...
	113, // 183: wandb_internal.ServerInfoResponse.local_info:type_name -> wandb_internal.LocalInfo
	107, // 184: wandb_internal.ServerInfoResponse.server_messages:type_name -> wandb_internal.ServerMessages
	108, // 185: wandb_internal.ServerMessages.item:type_name -> wandb_internal.ServerMessage
	9,   // 186: wandb_internal.FileTransferInfoRequest.type:type_name -> wandb_internal.FileTransferInfoRequest.TransferType
	109, // 187: wandb_internal.FileTransferInfoRequest.file_counts:type_name -> wandb_internal.FileCounts
	...
	19,  // 190: wandb_internal.AttachResponse.run:type_name -> wandb_internal.RunRecord
	22,  // 191: wandb_internal.AttachResponse.error:type_name -> wandb_internal.ErrorInfo
	180, // 192: wandb_internal.TestInjectRequest._info:type_name -> wandb_internal._RequestInfo
	31,  // 193: wandb_internal.PartialHistoryRequest.item:type_name -> wandb_internal.HistoryItem
	29,  // 194: wandb_internal.PartialHistoryRequest.step:type_name -> wandb_internal.HistoryStep
	120, // 195: wandb_internal.PartialHistoryRequest.action:type_name -> wandb_internal.HistoryAction
	180, // 196: wandb_internal.PartialHistoryRequest._info:type_name -> wandb_internal._RequestInfo
	10,  // 197: wandb_internal.RunLogRequest.level:type_name -> wandb_internal.RunLogRequest.Level
	180, // 198: wandb_internal.RunLogRequest._info:type_name -> wandb_internal._RequestInfo
	180, // 199: wandb_internal.SampledHistoryRequest._info:type_name -> wandb_internal._RequestInfo
	127, // 200: wandb_internal.SampledHistoryResponse.item:type_name -> wandb_internal.SampledHistoryItem
	...
	19,  // 203: wandb_internal.RunStartRequest.run:type_name -> wandb_internal.RunRecord
	180, // 204: wandb_internal.RunStartRequest._info:type_name -> wandb_internal._RequestInfo
	180, // 205: wandb_internal.CheckVersionRequest._info:type_name -> wandb_internal._RequestInfo
	180, // 206: wandb_internal.JobInfoRequest._info:type_name -> wandb_internal._RequestInfo
	54,  // 207: wandb_internal.LogArtifactRequest.artifact:type_name -> wandb_internal.ArtifactRecord
	180, // 208: wandb_internal.LogArtifactRequest._info:type_name -> wandb_internal._RequestInfo
	180, // 209: wandb_internal.DownloadArtifactRequest._info:type_name -> wandb_internal._RequestInfo
	180, // 210: wandb_internal.KeepaliveRequest._info:type_name -> wandb_internal._RequestInfo
	144, // 211: wandb_internal.GitSource.git_info:type_name -> wandb_internal.GitInfo
	145, // 212: wandb_internal.Source.git:type_name -> wandb_internal.GitSource
	143, // 213: wandb_internal.Source.artifact:type_name -> wandb_internal.ArtifactInfo
	146, // 214: wandb_internal.Source.image:type_name -> wandb_internal.ImageSource
	147, // 215: wandb_internal.JobSource.source:type_name -> wandb_internal.Source
	148, // 216: wandb_internal.PartialJobArtifact.source_info:type_name -> wandb_internal.JobSource
	149, // 217: wandb_internal.UseArtifactRecord.partial:type_name -> wandb_internal.PartialJobArtifact
	177, // 218: wandb_internal.UseArtifactRecord._info:type_name -> wandb_internal._RecordInfo
	180, // 219: wandb_internal.CancelRequest._info:type_name -> wandb_internal._RequestInfo
	179, // 220: wandb_internal.EnvironmentRecord.started_at:type_name -> google.protobuf.Timestamp
	20,  // 221: wandb_internal.EnvironmentRecord.git:type_name -> wandb_internal.GitRepoRecord
	170, // 222: wandb_internal.EnvironmentRecord.disk:type_name -> wandb_internal.EnvironmentRecord.DiskEntry
	156, // 223: wandb_internal.EnvironmentRecord.memory:type_name -> wandb_internal.MemoryInfo
	157, // 224: wandb_internal.EnvironmentRecord.cpu:type_name -> wandb_internal.CpuInfo
	158, // 225: wandb_internal.EnvironmentRecord.apple:type_name -> wandb_internal.AppleInfo
	159, // 226: wandb_internal.EnvironmentRecord.gpu_nvidia:type_name -> wandb_internal.GpuNvidiaInfo
	160, // 227: wandb_internal.EnvironmentRecord.gpu_amd:type_name -> wandb_internal.GpuAmdInfo
	171, // 228: wandb_internal.EnvironmentRecord.slurm:type_name -> wandb_internal.EnvironmentRecord.SlurmEntry
	161, // 229: wandb_internal.EnvironmentRecord.trainium:type_name -> wandb_internal.TrainiumInfo
	162, // 230: wandb_internal.EnvironmentRecord.tpu:type_name -> wandb_internal.TPUInfo
	163, // 231: wandb_internal.EnvironmentRecord.coreweave:type_name -> wandb_internal.CoreWeaveInfo
	177, // 232: wandb_internal.EnvironmentRecord._info:type_name -> wandb_internal._RecordInfo
	...
	167, // 236: wandb_internal.JobInputRequest.input_source:type_name -> wandb_internal.JobInputSource
	166, // 237: wandb_internal.JobInputRequest.include_paths:type_name -> wandb_internal.JobInputPath
	166, // 238: wandb_internal.JobInputRequest.exclude_paths:type_name -> wandb_internal.JobInputPath
	80,  // 239: wandb_internal.GetSystemMetricsResponse.SystemMetricsEntry.value:type_name -> wandb_internal.SystemMetricsBuffer
	155, // 240: wandb_internal.EnvironmentRecord.DiskEntry.value:type_name -> wandb_internal.DiskInfo
