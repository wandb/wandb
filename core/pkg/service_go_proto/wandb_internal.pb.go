...
const (
	...
	ServerFeature_AUTOMATION_ACTION_ARIA ServerFeature = 36
)
...
const file_wandb_proto_wandb_internal_proto_rawDesc = "" +
	...
	"\finput_schema\x18\x04 \x01(\tR\vinputSchema*\xb6\n" +
	"\n" +
	...
	"\x16SWEEPS_LOCAL_SCHEDULER\x10#\x12\x1a\n" +
