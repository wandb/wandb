...
const (
	...
	// Indicates that the deployment exposes the SDK OpenTelemetry proxy routes.
	ServerFeature_SDK_TELEMETRY_PROXY ServerFeature = 36
)
...
const file_wandb_proto_wandb_internal_proto_rawDesc = "" +
	...
	"\finput_schema\x18\x04 \x01(\tR\vinputSchema*\xb3\n" +
	"\n" +
	...
	"\x16SWEEPS_LOCAL_SCHEDULER\x10#\x12\x17\n" +
	"\x13SDK_TELEMETRY_PROXY\x10$B\x1bZ\x19core/pkg/service_go_protob\x06proto3"
