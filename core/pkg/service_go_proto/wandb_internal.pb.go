...
func (MetricRecord_MetricGoal) EnumDescriptor() ([]byte, []int) {
	return file_wandb_proto_wandb_internal_proto_rawDescGZIP(), []int{29, 0}
}
...
func (FilesItem_FileType) EnumDescriptor() ([]byte, []int) {
	return file_wandb_proto_wandb_internal_proto_rawDescGZIP(), []int{41, 1}
}
...
func (StatsRecord_StatsType) EnumDescriptor() ([]byte, []int) {
	return file_wandb_proto_wandb_internal_proto_rawDescGZIP(), []int{43, 0}
}
...
type Record_DeviceBinding struct {
	DeviceBinding *DeviceBindingRecord `protobuf:"bytes,28,opt,name=device_binding,json=deviceBinding,proto3,oneof"`
}
...
func (x *HistoryValue) GetValue() isHistoryValue_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (*JobInputSource_RunConfigSource) Descriptor() ([]byte, []int) {
	return file_wandb_proto_wandb_internal_proto_rawDescGZIP(), []int{157, 0}
}
...
func (*JobInputSource_ConfigFileSource) Descriptor() ([]byte, []int) {
	return file_wandb_proto_wandb_internal_proto_rawDescGZIP(), []int{157, 1}
}
...
const file_wandb_proto_wandb_internal_proto_rawDesc = "" +
	"\n" +
	" wandb/proto/wandb_internal.proto\x12\x0ewandb_internal\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cwandb/proto/wandb_base.proto\x1a!wandb/proto/wandb_telemetry.proto\"\xce\f\n" +
	"\x06Record\x12\x10\n" +
	...
	"\x0edevice_binding\x18\x1c \x01(\v2#.wandb_internal.DeviceBindingRecordH\x00R\rdeviceBinding\x123\n" +
	...
	"\tmac_model\x18\b \x01(\tR\bmacModel\"\xd3\x01\n" +
	...
	"\n" +
	"pci_bus_id\x18\x06 \x01(\tR\bpciBusId\x12\x16\n" +
	"\x06serial\x18\a \x01(\tR\x06serial\"\x95\x03\n" +
	"\n" +
	"GpuAmdInfo\x12\x0e\n" +
...
var file_wandb_proto_wandb_internal_proto_goTypes = []any{
	...
	(*HistoryValue)(nil),                        // 30: wandb_internal.HistoryValue
	...
	(*OutputLoggerRecord)(nil),                  // 37: wandb_internal.OutputLoggerRecord
	(*DeviceBindingRecord)(nil),                 // 38: wandb_internal.DeviceBindingRecord
...
var file_wandb_proto_wandb_internal_proto_depIdxs = []int32{
	...
	37,  // 21: wandb_internal.Record.output_logger:type_name -> wandb_internal.OutputLoggerRecord
	38,  // 22: wandb_internal.Record.device_binding:type_name -> wandb_internal.DeviceBindingRecord
	68,  // 23: wandb_internal.Record.request:type_name -> wandb_internal.Request
	11,  // 24: wandb_internal.Record.control:type_name -> wandb_internal.Control
	177, // 25: wandb_internal.Record._info:type_name -> wandb_internal._RecordInfo
	20,  // 26: wandb_internal.Result.run_result:type_name -> wandb_internal.RunUpdateResult
	23,  // 27: wandb_internal.Result.exit_result:type_name -> wandb_internal.RunExitResult
	32,  // 28: wandb_internal.Result.log_result:type_name -> wandb_internal.HistoryResult
	49,  // 29: wandb_internal.Result.summary_result:type_name -> wandb_internal.SummaryResult
	34,  // 30: wandb_internal.Result.output_result:type_name -> wandb_internal.OutputResult
	46,  // 31: wandb_internal.Result.config_result:type_name -> wandb_internal.ConfigResult
	69,  // 32: wandb_internal.Result.response:type_name -> wandb_internal.Response
	11,  // 33: wandb_internal.Result.control:type_name -> wandb_internal.Control
	178, // 34: wandb_internal.Result._info:type_name -> wandb_internal._ResultInfo
	177, // 35: wandb_internal.FinalRecord._info:type_name -> wandb_internal._RecordInfo
	177, // 36: wandb_internal.VersionInfo._info:type_name -> wandb_internal._RecordInfo
	14,  // 37: wandb_internal.HeaderRecord.version_info:type_name -> wandb_internal.VersionInfo
	177, // 38: wandb_internal.HeaderRecord._info:type_name -> wandb_internal._RecordInfo
	177, // 39: wandb_internal.FooterRecord._info:type_name -> wandb_internal._RecordInfo
	44,  // 40: wandb_internal.RunRecord.config:type_name -> wandb_internal.ConfigRecord
	47,  // 41: wandb_internal.RunRecord.summary:type_name -> wandb_internal.SummaryRecord
	26,  // 42: wandb_internal.RunRecord.settings:type_name -> wandb_internal.SettingsRecord
	179, // 43: wandb_internal.RunRecord.start_time:type_name -> google.protobuf.Timestamp
	175, // 44: wandb_internal.RunRecord.telemetry:type_name -> wandb_internal.TelemetryRecord
	19,  // 45: wandb_internal.RunRecord.git:type_name -> wandb_internal.GitRepoRecord
	17,  // 46: wandb_internal.RunRecord.branch_point:type_name -> wandb_internal.BranchPoint
	177, // 47: wandb_internal.RunRecord._info:type_name -> wandb_internal._RecordInfo
	18,  // 48: wandb_internal.RunUpdateResult.run:type_name -> wandb_internal.RunRecord
	21,  // 49: wandb_internal.RunUpdateResult.error:type_name -> wandb_internal.ErrorInfo
	1,   // 50: wandb_internal.ErrorInfo.code:type_name -> wandb_internal.ErrorInfo.ErrorCode
	177, // 51: wandb_internal.RunExitRecord._info:type_name -> wandb_internal._RecordInfo
	177, // 52: wandb_internal.RunPreemptingRecord._info:type_name -> wandb_internal._RecordInfo
	27,  // 53: wandb_internal.SettingsRecord.item:type_name -> wandb_internal.SettingsItem
	177, // 54: wandb_internal.SettingsRecord._info:type_name -> wandb_internal._RecordInfo
	...
	177, // 57: wandb_internal.HistoryRecord._info:type_name -> wandb_internal._RecordInfo
	180, // 58: wandb_internal.HistoryValue.none:type_name -> google.protobuf.NullValue
	30,  // 59: wandb_internal.HistoryItem.value:type_name -> wandb_internal.HistoryValue
	2,   // 60: wandb_internal.OutputRecord.output_type:type_name -> wandb_internal.OutputRecord.OutputType
	179, // 61: wandb_internal.OutputRecord.timestamp:type_name -> google.protobuf.Timestamp
	177, // 62: wandb_internal.OutputRecord._info:type_name -> wandb_internal._RecordInfo
	3,   // 63: wandb_internal.OutputRawRecord.output_type:type_name -> wandb_internal.OutputRawRecord.OutputType
	179, // 64: wandb_internal.OutputRawRecord.timestamp:type_name -> google.protobuf.Timestamp
	177, // 65: wandb_internal.OutputRawRecord._info:type_name -> wandb_internal._RecordInfo
	177, // 66: wandb_internal.DeviceBindingRecord._info:type_name -> wandb_internal._RecordInfo
	41,  // 67: wandb_internal.MetricRecord.options:type_name -> wandb_internal.MetricOptions
	43,  // 68: wandb_internal.MetricRecord.summary:type_name -> wandb_internal.MetricSummary
	4,   // 69: wandb_internal.MetricRecord.goal:type_name -> wandb_internal.MetricRecord.MetricGoal
	42,  // 70: wandb_internal.MetricRecord._control:type_name -> wandb_internal.MetricControl
	177, // 71: wandb_internal.MetricRecord._info:type_name -> wandb_internal._RecordInfo
	45,  // 72: wandb_internal.ConfigRecord.update:type_name -> wandb_internal.ConfigItem
	45,  // 73: wandb_internal.ConfigRecord.remove:type_name -> wandb_internal.ConfigItem
	177, // 74: wandb_internal.ConfigRecord._info:type_name -> wandb_internal._RecordInfo
	48,  // 75: wandb_internal.SummaryRecord.update:type_name -> wandb_internal.SummaryItem
	48,  // 76: wandb_internal.SummaryRecord.remove:type_name -> wandb_internal.SummaryItem
	177, // 77: wandb_internal.SummaryRecord._info:type_name -> wandb_internal._RecordInfo
	51,  // 78: wandb_internal.FilesRecord.files:type_name -> wandb_internal.FilesItem
	177, // 79: wandb_internal.FilesRecord._info:type_name -> wandb_internal._RecordInfo
	5,   // 80: wandb_internal.FilesItem.policy:type_name -> wandb_internal.FilesItem.PolicyType
	6,   // 81: wandb_internal.FilesItem.type:type_name -> wandb_internal.FilesItem.FileType
	7,   // 82: wandb_internal.StatsRecord.stats_type:type_name -> wandb_internal.StatsRecord.StatsType
	179, // 83: wandb_internal.StatsRecord.timestamp:type_name -> google.protobuf.Timestamp
	54,  // 84: wandb_internal.StatsRecord.item:type_name -> wandb_internal.StatsItem
	177, // 85: wandb_internal.StatsRecord._info:type_name -> wandb_internal._RecordInfo
	56,  // 86: wandb_internal.ArtifactRecord.manifest:type_name -> wandb_internal.ArtifactManifest
	177, // 87: wandb_internal.ArtifactRecord._info:type_name -> wandb_internal._RecordInfo
	59,  // 88: wandb_internal.ArtifactManifest.storage_policy_config:type_name -> wandb_internal.StoragePolicyConfigItem
	57,  // 89: wandb_internal.ArtifactManifest.contents:type_name -> wandb_internal.ArtifactManifestEntry
	58,  // 90: wandb_internal.ArtifactManifestEntry.extra:type_name -> wandb_internal.ExtraItem
	177, // 91: wandb_internal.LinkArtifactRequest._info:type_name -> wandb_internal._RecordInfo
	177, // 92: wandb_internal.TBRecord._info:type_name -> wandb_internal._RecordInfo
	177, // 93: wandb_internal.AlertRecord._info:type_name -> wandb_internal._RecordInfo
	85,  // 94: wandb_internal.Request.stop_status:type_name -> wandb_internal.StopStatusRequest
	87,  // 95: wandb_internal.Request.network_status:type_name -> wandb_internal.NetworkStatusRequest
	70,  // 96: wandb_internal.Request.defer:type_name -> wandb_internal.DeferRequest
	77,  // 97: wandb_internal.Request.get_summary:type_name -> wandb_internal.GetSummaryRequest
	75,  // 98: wandb_internal.Request.login:type_name -> wandb_internal.LoginRequest
	71,  // 99: wandb_internal.Request.pause:type_name -> wandb_internal.PauseRequest
	73,  // 100: wandb_internal.Request.resume:type_name -> wandb_internal.ResumeRequest
	93,  // 101: wandb_internal.Request.poll_exit:type_name -> wandb_internal.PollExitRequest
	126, // 102: wandb_internal.Request.sampled_history:type_name -> wandb_internal.SampledHistoryRequest
	122, // 103: wandb_internal.Request.partial_history:type_name -> wandb_internal.PartialHistoryRequest
	124, // 104: wandb_internal.Request.history_step:type_name -> wandb_internal.HistoryStepRequest
	131, // 105: wandb_internal.Request.run_start:type_name -> wandb_internal.RunStartRequest
	133, // 106: wandb_internal.Request.check_version:type_name -> wandb_internal.CheckVersionRequest
	137, // 107: wandb_internal.Request.log_artifact:type_name -> wandb_internal.LogArtifactRequest
	139, // 108: wandb_internal.Request.download_artifact:type_name -> wandb_internal.DownloadArtifactRequest
	141, // 109: wandb_internal.Request.keepalive:type_name -> wandb_internal.KeepaliveRequest
	129, // 110: wandb_internal.Request.run_status:type_name -> wandb_internal.RunStatusRequest
	152, // 111: wandb_internal.Request.cancel:type_name -> wandb_internal.CancelRequest
	90,  // 112: wandb_internal.Request.internal_messages:type_name -> wandb_internal.InternalMessagesRequest
	165, // 113: wandb_internal.Request.python_packages:type_name -> wandb_internal.PythonPackagesRequest
	115, // 114: wandb_internal.Request.shutdown:type_name -> wandb_internal.ShutdownRequest
	117, // 115: wandb_internal.Request.attach:type_name -> wandb_internal.AttachRequest
	83,  // 116: wandb_internal.Request.status:type_name -> wandb_internal.StatusRequest
	106, // 117: wandb_internal.Request.server_info:type_name -> wandb_internal.ServerInfoRequest
	99,  // 118: wandb_internal.Request.sender_mark:type_name -> wandb_internal.SenderMarkRequest
	102, // 119: wandb_internal.Request.sender_read:type_name -> wandb_internal.SenderReadRequest
	103, // 120: wandb_internal.Request.status_report:type_name -> wandb_internal.StatusReportRequest
	104, // 121: wandb_internal.Request.summary_record:type_name -> wandb_internal.SummaryRecordRequest
	105, // 122: wandb_internal.Request.telemetry_record:type_name -> wandb_internal.TelemetryRecordRequest
	135, // 123: wandb_internal.Request.job_info:type_name -> wandb_internal.JobInfoRequest
	79,  // 124: wandb_internal.Request.get_system_metrics:type_name -> wandb_internal.GetSystemMetricsRequest
	168, // 125: wandb_internal.Request.job_input:type_name -> wandb_internal.JobInputRequest
	62,  // 126: wandb_internal.Request.link_artifact:type_name -> wandb_internal.LinkArtifactRequest
	100, // 127: wandb_internal.Request.sync_finish:type_name -> wandb_internal.SyncFinishRequest
	95,  // 128: wandb_internal.Request.operations:type_name -> wandb_internal.OperationStatsRequest
	154, // 129: wandb_internal.Request.probe_system_info:type_name -> wandb_internal.ProbeSystemInfoRequest
	119, // 130: wandb_internal.Request.test_inject:type_name -> wandb_internal.TestInjectRequest
	142, // 131: wandb_internal.Response.keepalive_response:type_name -> wandb_internal.KeepaliveResponse
	86,  // 132: wandb_internal.Response.stop_status_response:type_name -> wandb_internal.StopStatusResponse
	88,  // 133: wandb_internal.Response.network_status_response:type_name -> wandb_internal.NetworkStatusResponse
	76,  // 134: wandb_internal.Response.login_response:type_name -> wandb_internal.LoginResponse
	78,  // 135: wandb_internal.Response.get_summary_response:type_name -> wandb_internal.GetSummaryResponse
	94,  // 136: wandb_internal.Response.poll_exit_response:type_name -> wandb_internal.PollExitResponse
	128, // 137: wandb_internal.Response.sampled_history_response:type_name -> wandb_internal.SampledHistoryResponse
	125, // 138: wandb_internal.Response.history_step_response:type_name -> wandb_internal.HistoryStepResponse
	132, // 139: wandb_internal.Response.run_start_response:type_name -> wandb_internal.RunStartResponse
	134, // 140: wandb_internal.Response.check_version_response:type_name -> wandb_internal.CheckVersionResponse
	138, // 141: wandb_internal.Response.log_artifact_response:type_name -> wandb_internal.LogArtifactResponse
	140, // 142: wandb_internal.Response.download_artifact_response:type_name -> wandb_internal.DownloadArtifactResponse
	130, // 143: wandb_internal.Response.run_status_response:type_name -> wandb_internal.RunStatusResponse
	153, // 144: wandb_internal.Response.cancel_response:type_name -> wandb_internal.CancelResponse
	91,  // 145: wandb_internal.Response.internal_messages_response:type_name -> wandb_internal.InternalMessagesResponse
	116, // 146: wandb_internal.Response.shutdown_response:type_name -> wandb_internal.ShutdownResponse
	118, // 147: wandb_internal.Response.attach_response:type_name -> wandb_internal.AttachResponse
	84,  // 148: wandb_internal.Response.status_response:type_name -> wandb_internal.StatusResponse
	107, // 149: wandb_internal.Response.server_info_response:type_name -> wandb_internal.ServerInfoResponse
	136, // 150: wandb_internal.Response.job_info_response:type_name -> wandb_internal.JobInfoResponse
	82,  // 151: wandb_internal.Response.get_system_metrics_response:type_name -> wandb_internal.GetSystemMetricsResponse
	63,  // 152: wandb_internal.Response.link_artifact_response:type_name -> wandb_internal.LinkArtifactResponse
	101, // 153: wandb_internal.Response.sync_response:type_name -> wandb_internal.SyncResponse
	96,  // 154: wandb_internal.Response.operations_response:type_name -> wandb_internal.OperationStatsResponse
	120, // 155: wandb_internal.Response.test_inject_response:type_name -> wandb_internal.TestInjectResponse
	8,   // 156: wandb_internal.DeferRequest.state:type_name -> wandb_internal.DeferRequest.DeferState
	181, // 157: wandb_internal.PauseRequest._info:type_name -> wandb_internal._RequestInfo
	181, // 158: wandb_internal.ResumeRequest._info:type_name -> wandb_internal._RequestInfo
	181, // 159: wandb_internal.LoginRequest._info:type_name -> wandb_internal._RequestInfo
	181, // 160: wandb_internal.GetSummaryRequest._info:type_name -> wandb_internal._RequestInfo
	48,  // 161: wandb_internal.GetSummaryResponse.item:type_name -> wandb_internal.SummaryItem
	181, // 162: wandb_internal.GetSystemMetricsRequest._info:type_name -> wandb_internal._RequestInfo
	179, // 163: wandb_internal.SystemMetricSample.timestamp:type_name -> google.protobuf.Timestamp
	80,  // 164: wandb_internal.SystemMetricsBuffer.record:type_name -> wandb_internal.SystemMetricSample
	169, // 165: wandb_internal.GetSystemMetricsResponse.system_metrics:type_name -> wandb_internal.GetSystemMetricsResponse.SystemMetricsEntry
	...
	47,  // 183: wandb_internal.SummaryRecordRequest.summary:type_name -> wandb_internal.SummaryRecord
	...
	127, // 201: wandb_internal.SampledHistoryResponse.item:type_name -> wandb_internal.SampledHistoryItem
	...
	181, // 206: wandb_internal.CheckVersionRequest._info:type_name -> wandb_internal._RequestInfo
	181, // 207: wandb_internal.JobInfoRequest._info:type_name -> wandb_internal._RequestInfo
	55,  // 208: wandb_internal.LogArtifactRequest.artifact:type_name -> wandb_internal.ArtifactRecord
	181, // 209: wandb_internal.LogArtifactRequest._info:type_name -> wandb_internal._RequestInfo
	181, // 210: wandb_internal.DownloadArtifactRequest._info:type_name -> wandb_internal._RequestInfo
	181, // 211: wandb_internal.KeepaliveRequest._info:type_name -> wandb_internal._RequestInfo
	144, // 212: wandb_internal.GitSource.git_info:type_name -> wandb_internal.GitInfo
	145, // 213: wandb_internal.Source.git:type_name -> wandb_internal.GitSource
	143, // 214: wandb_internal.Source.artifact:type_name -> wandb_internal.ArtifactInfo
	146, // 215: wandb_internal.Source.image:type_name -> wandb_internal.ImageSource
	147, // 216: wandb_internal.JobSource.source:type_name -> wandb_internal.Source
	148, // 217: wandb_internal.PartialJobArtifact.source_info:type_name -> wandb_internal.JobSource
	149, // 218: wandb_internal.UseArtifactRecord.partial:type_name -> wandb_internal.PartialJobArtifact
	177, // 219: wandb_internal.UseArtifactRecord._info:type_name -> wandb_internal._RecordInfo
	181, // 220: wandb_internal.CancelRequest._info:type_name -> wandb_internal._RequestInfo
	179, // 221: wandb_internal.EnvironmentRecord.started_at:type_name -> google.protobuf.Timestamp
	...
	156, // 224: wandb_internal.EnvironmentRecord.memory:type_name -> wandb_internal.MemoryInfo
	157, // 225: wandb_internal.EnvironmentRecord.cpu:type_name -> wandb_internal.CpuInfo
	158, // 226: wandb_internal.EnvironmentRecord.apple:type_name -> wandb_internal.AppleInfo
	159, // 227: wandb_internal.EnvironmentRecord.gpu_nvidia:type_name -> wandb_internal.GpuNvidiaInfo
	160, // 228: wandb_internal.EnvironmentRecord.gpu_amd:type_name -> wandb_internal.GpuAmdInfo
	171, // 229: wandb_internal.EnvironmentRecord.slurm:type_name -> wandb_internal.EnvironmentRecord.SlurmEntry
	161, // 230: wandb_internal.EnvironmentRecord.trainium:type_name -> wandb_internal.TrainiumInfo
	162, // 231: wandb_internal.EnvironmentRecord.tpu:type_name -> wandb_internal.TPUInfo
	163, // 232: wandb_internal.EnvironmentRecord.coreweave:type_name -> wandb_internal.CoreWeaveInfo
	177, // 233: wandb_internal.EnvironmentRecord._info:type_name -> wandb_internal._RecordInfo
	...
	167, // 237: wandb_internal.JobInputRequest.input_source:type_name -> wandb_internal.JobInputSource
	166, // 238: wandb_internal.JobInputRequest.include_paths:type_name -> wandb_internal.JobInputPath
	166, // 239: wandb_internal.JobInputRequest.exclude_paths:type_name -> wandb_internal.JobInputPath
	81,  // 240: wandb_internal.GetSystemMetricsResponse.SystemMetricsEntry.value:type_name -> wandb_internal.SystemMetricsBuffer
	155, // 241: wandb_internal.EnvironmentRecord.DiskEntry.value:type_name -> wandb_internal.DiskInfo
...
func file_wandb_proto_wandb_internal_proto_init() {
	...
	file_wandb_proto_wandb_internal_proto_msgTypes[157].OneofWrappers = []any{
