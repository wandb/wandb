...
type RunRecord struct {
	...
	SyncMayReassignSteps bool         `protobuf:"varint,25,opt,name=sync_may_reassign_steps,json=syncMayReassignSteps,proto3" json:"sync_may_reassign_steps,omitempty"`
	XInfo                *XRecordInfo `protobuf:"bytes,200,opt,name=_info,json=Info,proto3" json:"_info,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *RunRecord) GetSyncMayReassignSteps() bool {
	if x != nil {
		return x.SyncMayReassignSteps
	}
	return false
}
...
const file_wandb_proto_wandb_internal_proto_rawDesc = "" +
	...
	"\x06metric\x18\x03 \x01(\tR\x06metric\"\x98\a\n" +
	"\tRunRecord\x12\x15\n" +
	...
	"\fbranch_point\x18\x17 \x01(\v2\x1b.wandb_internal.BranchPointR\vbranchPoint\x125\n" +
	"\x17sync_may_reassign_steps\x18\x19 \x01(\bR\x14syncMayReassignSteps\x121\n" +
