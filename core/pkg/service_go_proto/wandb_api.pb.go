...
const file_wandb_proto_wandb_api_proto_rawDesc = "" +
	...
	"\x06api_id\x18\x02 \x01(\tR\x05apiId\"\x90\x01\n" +
	"\n" +
	"ApiRequest\x12\x15\n" +
	"\x06api_id\x18\x01 \x01(\tR\x05apiId\x12`\n" +
	"\x18read_run_history_request\x18\x02 \x01(\v2%.wandb_internal.ReadRunHistoryRequestH\x00R\x15readRunHistoryRequestB\t\n" +
	"\arequest\"\xd0\x01\n" +
	"\vApiResponse\x12c\n" +
	"\x19read_run_history_response\x18\x01 \x01(\v2&.wandb_internal.ReadRunHistoryResponseH\x00R\x16readRunHistoryResponse\x12P\n" +
	...
	"\x06api_id\x18\x01 \x01(\tR\x05apiId\"\xd1\x04\n" +
