...
type Settings struct {
	...
	//
	// By default, buffered run data is written to the .wandb file about once
	// a second, less often on slow filesystems, so that tools reading the
	// file see a running run's progress. When disabled, data is written only
	// when a buffer fills or the run finishes.
	XDisableTransactionLogFlush *wrapperspb.BoolValue `protobuf:"bytes,209,opt,name=x_disable_transaction_log_flush,json=xDisableTransactionLogFlush,proto3" json:"x_disable_transaction_log_flush,omitempty"`
...
func (x *Settings) GetXDisableTransactionLogFlush() *wrapperspb.BoolValue {
	if x != nil {
		return x.XDisableTransactionLogFlush
	}
	return nil
}
...
const file_wandb_proto_wandb_settings_proto_rawDesc = "" +
	...
	"\x06metric\x18\x03 \x01(\tR\x06metric\"\xd5g\n" +
	"\bSettings\x125\n" +
	...
	"\x16x_skip_transaction_log\x18\xbf\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x13xSkipTransactionLog\x12a\n" +
	"\x1fx_disable_transaction_log_flush\x18\xd1\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\x1bxDisableTransactionLogFlush\x12j\n" +
...
var file_wandb_proto_wandb_settings_proto_depIdxs = []int32{
	...
	10,  // 100: wandb_internal.Settings.x_disable_transaction_log_flush:type_name -> google.protobuf.BoolValue
