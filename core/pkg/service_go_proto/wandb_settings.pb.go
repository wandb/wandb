...
func (x *Settings) GetXHistoryValueEncoding() *wrapperspb.StringValue {
	if x != nil {
		return x.XHistoryValueEncoding
	}
	return nil
}
...
const file_wandb_proto_wandb_settings_proto_rawDesc = "" +
	...
	"\x06metric\x18\x03 \x01(\tR\x06metric\"\xd3g\n" +
	"\bSettings\x125\n" +
	...
	"\x18x_history_value_encoding\x18\xd2\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x15xHistoryValueEncoding\x12V\n" +
...
var file_wandb_proto_wandb_settings_proto_depIdxs = []int32{
	...
	9,   // 35: wandb_internal.Settings.x_history_value_encoding:type_name -> google.protobuf.StringValue
