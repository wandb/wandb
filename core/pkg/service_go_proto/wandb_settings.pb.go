...
func (x *Settings) GetXFileStreamTransmitIntervalInitial() *wrapperspb.DoubleValue {
	if x != nil {
		return x.XFileStreamTransmitIntervalInitial
	}
	return nil
}
...
const file_wandb_proto_wandb_settings_proto_rawDesc = "" +
	...
	"\x06metric\x18\x03 \x01(\tR\x06metric\"\xd2g\n" +
	"\bSettings\x125\n" +
	...
	"\x1fx_file_stream_transmit_interval\x18\xaf\x01 \x01(\v2\x1c.google.protobuf.DoubleValueR\x1bxFileStreamTransmitInterval\x12r\n" +
	"'x_file_stream_transmit_interval_initial\x18\xd0\x01 \x01(\v2\x1c.google.protobuf.DoubleValueR\"xFileStreamTransmitIntervalInitial\x12X\n" +
...
var file_wandb_proto_wandb_settings_proto_depIdxs = []int32{
	...
	11,  // 28: wandb_internal.Settings.x_file_stream_transmit_interval_initial:type_name -> google.protobuf.DoubleValue
