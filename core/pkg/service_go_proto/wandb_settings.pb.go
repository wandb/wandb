...
type Settings struct {
	...
	FinishTimeout *wrapperspb.DoubleValue `protobuf:"bytes,205,opt,name=finish_timeout,json=finishTimeout,proto3" json:"finish_timeout,omitempty"`
...
const file_wandb_proto_wandb_settings_proto_rawDesc = "" +
	...
	"\x06metric\x18\x03 \x01(\tR\x06metric\"\xcae\n" +
	"\bSettings\x125\n" +
	...
	"\x0efinish_timeout\x18\xcd\x01 \x01(\v2\x1c.google.protobuf.DoubleValueR\rfinishTimeout\x12>\n" +
