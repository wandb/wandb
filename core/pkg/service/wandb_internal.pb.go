...
type ConfigFileParameterRecord struct {
	...
	Paths   []*ConfigFilterPath `protobuf:"bytes,2,rep,name=paths,proto3" json:"paths,omitempty"`
...
func (x *ConfigFileParameterRecord) GetPaths() []*ConfigFilterPath {
	if x != nil {
		return x.Paths
	}
	return nil
...
func (x *ConfigFileParameterRecord) GetExclude() bool {
	if x != nil {
		return x.Exclude
	}
	return false
