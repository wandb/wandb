...
source = ("org", "team", "project", "env", "sysdir", "dir", "setup", "settings", "args")
...
class Settings(object):
    def __init__(self, settings=None, environ=None, early_logging=None):
        ...
        # object.__setattr__(self, "_forced_dict", _forced_dict)  # set source where force happened
        # object.__setattr__(self, "_assignment_dict", _forced_dict)  # set source where assignment happened
