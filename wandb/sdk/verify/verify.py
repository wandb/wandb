...
def check_cors_configuration(url: str, origin: str) -> None:
    ...
    try:
        ...
        # A rejected preflight response may still carry CORS headers.
...
def check_large_post() -> bool:
    ...
    try:
        ...
        if (
            isinstance(e, WandbApiFailedError)
            and e.response is not None
            and e.response.http_status == HTTPStatus.REQUEST_ENTITY_TOO_LARGE.value
        ):
            failed_test_strings.append(
