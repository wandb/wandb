...
def registry_from_uri(uri: str) -> AbstractRegistryHelper:
    ...
    if ".azurecr.io" in uri:
        ...
        return AzureContainerRegistryHelper(uri=uri)
        ...
        return GoogleArtifactRegistryHelper(uri=uri)
        ...
        return ElasticContainerRegistryHelper(uri=uri)
