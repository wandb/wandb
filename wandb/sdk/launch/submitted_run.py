...
class SubmittedRun(object):
    """
    Wrapper around a W&B project run (e.g. a subprocess running an entry point
    command) and exposing methods for waiting on and cancelling the run.
    This class defines the interface that the W&B project runner uses to manage the lifecycle
