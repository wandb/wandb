...
class Op(Base):
    ...
    def to_mongo_dict(self, handler: SerializerFunctionWrapHandler) -> dict[str, Any]:
    ...
    @classmethod
    def from_mongo_dict(cls, data: Any) -> Any:
        """Parse from a MongoDB query dict."""
        # If needed, converg e.g. `{"$gt": 123}` -> `{"other": 123}` before instantiation
