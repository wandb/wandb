...
if TYPE_CHECKING:
    from .comparison import ScalarT
...
class FilteredField(str):
    ...
    # ------------------------------------------------------------------------------
    def lt(self, other: ScalarT) -> FilterExpr:
        return self.__lt__(other)

    def gt(self, other: ScalarT) -> FilterExpr:
        return self.__gt__(other)

    def lte(self, other: ScalarT) -> FilterExpr:
        return self.__le__(other)

    def gte(self, other: ScalarT) -> FilterExpr:
        return self.__ge__(other)

    def ne(self, other: ScalarT) -> FilterExpr:
        return self.__ne__(other)

    def eq(self, other: ScalarT) -> FilterExpr:
        return self.__eq__(other)

    def in_(self, other: Iterable[ScalarT]) -> FilterExpr:
        return FilterExpr({self: In(other=other)})

    def not_in(self, other: Iterable[ScalarT]) -> FilterExpr:
    ...
    # ------------------------------------------------------------------------------
    def __lt__(self, other: ScalarT) -> FilterExpr:  # type: ignore[override,misc]
        return FilterExpr({self: Lt(other=other)})

    def __gt__(self, other: ScalarT) -> FilterExpr:  # type: ignore[override,misc]
        return FilterExpr({self: Gt(other=other)})

    def __le__(self, other: ScalarT) -> FilterExpr:  # type: ignore[override,misc]
        return FilterExpr({self: Lte(other=other)})

    def __ge__(self, other: ScalarT) -> FilterExpr:  # type: ignore[override,misc]
        return FilterExpr({self: Gte(other=other)})

    def __eq__(self, other: ScalarT) -> FilterExpr:  # type: ignore[override]
        return FilterExpr({self: Eq(other=other)})

    def __ne__(self, other: ScalarT) -> FilterExpr:  # type: ignore[override]
