...
class WebhookIntegrationConnectionFields(GQLBase):
    typename__: Typename[str]
    page_info: PageInfoFields = Field(alias="pageInfo")
    edges: list[WebhookIntegrationConnectionFieldsEdges]


class WebhookIntegrationConnectionFieldsEdges(GQLBase):
    cursor: str
    node: (
        Annotated[
...
class WebhookIntegrationConnectionFieldsEdgesNodeIntegration(GQLBase):
    typename__: Typename[
        Literal["GitHubOAuthIntegration", "Integration", "SlackIntegration"]
    ]
...
class WebhookIntegrationConnectionFieldsEdgesNodeGenericWebhookIntegration(
    WebhookIntegrationFields
):
    typename__: Typename[Literal["GenericWebhookIntegration"]]
...
WebhookIntegrationConnectionFields.model_rebuild()
