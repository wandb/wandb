...
class ArtifactManifestV1(ArtifactManifest):
    version_: Annotated[Literal[1], Field(alias="version", repr=False)] = 1
    ...
    def _validate_entries(cls, v: Any) -> Any:
        ...
        return {path: {**dict(obj), "path": path} for path, obj in v.items()}
    ...
    def from_manifest_json(
        ...
        return cls(version_=data.version, entries=data.contents, storage_policy=policy)
