...
class S3Handler(StorageHandler):
    ...
    def load_path(
        ...
        if etag != manifest_entry.digest:
            ...
            for object_version in object_versions:
                if manifest_entry_etag == object_version.etag.strip('"'):
    ...
    def _size_from_obj(self, obj: boto3.s3.Object | boto3.s3.ObjectSummary) -> int:
        ...
        return getattr(obj, "size", obj.content_length)
    ...
    def _extra_from_obj(
        ...
        extra = {"etag": obj.e_tag.strip('"')}  # escape leading and trailing quote
