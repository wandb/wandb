...
class Artifact:
    ...
    def _assign_attrs(self, attrs: dict[str, Any]) -> None:
        """Populate or repopulate the internal attributes of this Artifact from the parsed, GQL-returned JSON object."""
        # TODO: In the future, consider dataclasses or generated pydantic types, which can handle much of this.
        #   Note: pydantic, if considered, readily handles runtime validation logic and camelCase aliases on each field.
        self._id = attrs["id"]
