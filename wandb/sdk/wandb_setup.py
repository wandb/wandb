...
class _WandbSetup:
    ...
    def finish_all_active_runs(self) -> None:
        ...
        setting together with `reinit="allow"` which does not seem to be a
        useful pattern. Since `"allow"` should eventually become the default
        and only behavior, it does not seem worth optimizing.
        """
