...
class Audio(BatchableMedia):
    ...
    def __init__(
        self: "Audio",
        data_or_path: Union[str, Path, "np.ndarray"],
    ...
    @classmethod
    def get_media_subdir(cls: Type["Audio"]) -> str:
    ...
    def to_json(self: "Audio", run: Union["Run", "Artifact"]) -> dict:
    ...
    def __eq__(self: "Audio", other: Any) -> bool:
    ...
    def __ne__(self: "Audio", other: Any) -> bool:
