...
class Molecule(BatchableMedia):
    ...
    def _from_rdkit(
        ...
        Args:
            data_or_path (string, rdkit.Chem.rdchem.Mol): Molecule can be
                initialized from a file name or an rdkit.Chem.rdchem.Mol object.
            caption (Optional[str]): Caption associated with the molecule for display.
            ...
            mmff_optimize_molecule_max_iterations (int): Number of iterations to use
                in rdkit.Chem.AllChem.MMFFOptimizeMolecule
        """
