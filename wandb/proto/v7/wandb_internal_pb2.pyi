...
class HistoryValue(_message.Message):
    ...
    string_value: str
    json_value: str
    def __init__(self, kind: _Optional[_Union[HistoryValue.Kind, str]] = ..., bool_value: _Optional[bool] = ..., int_value: _Optional[int] = ..., float_value: _Optional[float] = ..., string_value: _Optional[str] = ..., json_value: _Optional[str] = ...) -> None: ...
