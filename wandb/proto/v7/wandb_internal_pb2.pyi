...
class TBRecord(_message.Message):
    ...
    save: bool
    save_path: str
    def __init__(self, _info: _Optional[_Union[_wandb_base_pb2._RecordInfo, _Mapping]] = ..., log_dir: _Optional[str] = ..., root_dir: _Optional[str] = ..., namespace: _Optional[str] = ..., save: _Optional[bool] = ..., save_path: _Optional[str] = ...) -> None: ...
