...
class Control(_message.Message):
    ...
    end_offset: int
    connection_id: str
    def __init__(self, req_resp: _Optional[bool] = ..., local: _Optional[bool] = ..., relay_id: _Optional[str] = ..., mailbox_slot: _Optional[str] = ..., flow_control: _Optional[bool] = ..., end_offset: _Optional[int] = ..., connection_id: _Optional[str] = ...) -> None: ...
...
class HistoryValue(_message.Message):
    ...
    string_value: str
    json_value: bytes
    def __init__(self, null_value: _Optional[_Union[_struct_pb2.NullValue, str]] = ..., bool_value: _Optional[bool] = ..., int_value: _Optional[int] = ..., float_value: _Optional[float] = ..., string_value: _Optional[str] = ..., json_value: _Optional[bytes] = ...) -> None: ...
...
class TBRecord(_message.Message):
    ...
    def __init__(self, _info: _Optional[_Union[_wandb_base_pb2._RecordInfo, _Mapping]] = ..., log_dir: _Optional[str] = ..., root_dir: _Optional[str] = ..., namespace: _Optional[str] = ..., save: _Optional[bool] = ..., save_path: _Optional[str] = ..., ignore_timestamp: _Optional[bool] = ..., ignore_hostname: _Optional[bool] = ...) -> None: ...
