...
class HistoryValue(_message.Message):
    ...
    string_value: str
    json_value: bytes
    def __init__(self, kind: _Optional[_Union[HistoryValue.Kind, str]] = ..., bool_value: _Optional[bool] = ..., number_value: _Optional[float] = ..., string_value: _Optional[str] = ..., json_value: _Optional[bytes] = ...) -> None: ...
