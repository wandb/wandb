...
class ServerApiInitResponse(_message.Message):
    ...
    API_ID_FIELD_NUMBER: _builtins.int
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["api_id", b"api_id", "error_message", b"error_message"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class ApiRequest(_message.Message):
    ...
    FEATURES_REQUEST_FIELD_NUMBER: _builtins.int
    api_id: _builtins.str
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["features_request", b"features_request", "read_run_history_request", b"read_run_history_request", "request", b"request"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["api_id", b"api_id", "features_request", b"features_request", "read_run_history_request", b"read_run_history_request", "request", b"request"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_request: _TypeAlias = _typing.Literal["read_run_history_request", "features_request"]  # noqa: Y015
...
class ApiResponse(_message.Message):
    ...
    FEATURES_RESPONSE_FIELD_NUMBER: _builtins.int
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["api_error_response", b"api_error_response", "features_response", b"features_response", "read_run_history_response", b"read_run_history_response", "response", b"response"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["api_error_response", b"api_error_response", "features_response", b"features_response", "read_run_history_response", b"read_run_history_response", "response", b"response"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_response: _TypeAlias = _typing.Literal["read_run_history_response", "features_response", "api_error_response"]  # noqa: Y015
...
class ServerApiCleanupRequest(_message.Message):
    ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["api_id", b"api_id"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
...
class FeaturesRequest(_message.Message):
    ...
    @_builtins.property
    def features(self) -> _containers.RepeatedScalarFieldContainer[_wandb_internal_pb2.ServerFeature.ValueType]:
    ...
    def __init__(
        self,
        *,
        features: _abc.Iterable[_wandb_internal_pb2.ServerFeature.ValueType] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["features", b"features"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___FeaturesRequest: _TypeAlias = FeaturesRequest  # noqa: Y015
...
class FeaturesResponse(_message.Message):
    ...
    @_builtins.property
    def enabled(self) -> _containers.RepeatedScalarFieldContainer[_wandb_internal_pb2.ServerFeature.ValueType]:
        """Names of enabled boolean features."""

    def __init__(
        self,
        *,
        enabled: _abc.Iterable[_wandb_internal_pb2.ServerFeature.ValueType] | None = ...,
    ) -> None: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["enabled", b"enabled"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___FeaturesResponse: _TypeAlias = FeaturesResponse  # noqa: Y015
