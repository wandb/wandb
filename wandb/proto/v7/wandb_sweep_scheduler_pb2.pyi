...
class SweepSchedulerServerWarmStartTask(_message.Message):
    ...
    has_more: bool
    def __init__(self, finished_runs: _Optional[_Iterable[_Union[SweepSchedulerServerRunData, _Mapping]]] = ..., active_runs: _Optional[_Iterable[_Union[SweepSchedulerServerRunData, _Mapping]]] = ..., has_more: _Optional[bool] = ...) -> None: ...
...
class SweepSchedulerServerRunUpdate(_message.Message):
    ...
    pruned: bool
    def __init__(self, run: _Optional[_Union[SweepSchedulerServerRunData, _Mapping]] = ..., pruned: _Optional[bool] = ...) -> None: ...
