...
_INTERNALSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='CreateArtifactPortfolio',
    full_name='wandb_internal.InternalService.CreateArtifactPortfolio',
    index=22,
    containing_service=None,
    input_type=wandb_dot_proto_dot_wandb__internal__pb2._CREATEARTIFACTPORTFOLIORECORD,
    output_type=wandb_dot_proto_dot_wandb__internal__pb2._CREATEARTIFACTPORTFOLIORESULT,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
