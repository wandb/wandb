...
_INTERNALSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ServerInfo',
    full_name='wandb_internal.InternalService.ServerInfo',
    index=7,
    containing_service=None,
    input_type=wandb_dot_proto_dot_wandb__internal__pb2._SERVERINFOREQUEST,
    output_type=wandb_dot_proto_dot_wandb__internal__pb2._SERVERINFORESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Keepalive',
    full_name='wandb_internal.InternalService.Keepalive',
    index=25,
    containing_service=None,
    input_type=wandb_dot_proto_dot_wandb__internal__pb2._KEEPALIVEREQUEST,
    output_type=wandb_dot_proto_dot_wandb__internal__pb2._KEEPALIVERESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
