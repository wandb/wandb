...
_INTERNALSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Checkpoint',
    full_name='wandb_internal.InternalService.Checkpoint',
    index=17,
    containing_service=None,
    input_type=wandb_dot_proto_dot_wandb__internal__pb2._CHECKPOINTRECORD,
    output_type=wandb_dot_proto_dot_wandb__internal__pb2._CHECKPOINTRESULT,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
