...
class ServerResponse(google.protobuf.message.Message):
    ...
    API_CLEANUP_RESPONSE_FIELD_NUMBER: builtins.int
    ...
    @property
    def api_cleanup_response(self) -> wandb.proto.wandb_api_pb2.ServerApiCleanupResponse: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        api_cleanup_response: wandb.proto.wandb_api_pb2.ServerApiCleanupResponse | None = ...,
        api_response: wandb.proto.wandb_api_pb2.ApiResponse | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["api_cleanup_response", b"api_cleanup_response", "api_init_response", b"api_init_response", "api_response", b"api_response", "authenticate_response", b"authenticate_response", "inform_attach_response", b"inform_attach_response", "inform_detach_response", b"inform_detach_response", "inform_finish_response", b"inform_finish_response", "inform_init_response", b"inform_init_response", "inform_teardown_response", b"inform_teardown_response", "init_sync_response", b"init_sync_response", "result_communicate", b"result_communicate", "server_response_type", b"server_response_type", "sync_response", b"sync_response", "sync_status_response", b"sync_status_response"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["api_cleanup_response", b"api_cleanup_response", "api_init_response", b"api_init_response", "api_response", b"api_response", "authenticate_response", b"authenticate_response", "inform_attach_response", b"inform_attach_response", "inform_detach_response", b"inform_detach_response", "inform_finish_response", b"inform_finish_response", "inform_init_response", b"inform_init_response", "inform_teardown_response", b"inform_teardown_response", "init_sync_response", b"init_sync_response", "request_id", b"request_id", "result_communicate", b"result_communicate", "server_response_type", b"server_response_type", "sync_response", b"sync_response", "sync_status_response", b"sync_status_response"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["server_response_type", b"server_response_type"]) -> typing_extensions.Literal["result_communicate", "inform_init_response", "inform_finish_response", "inform_attach_response", "inform_detach_response", "inform_teardown_response", "authenticate_response", "init_sync_response", "sync_response", "sync_status_response", "api_init_response", "api_cleanup_response", "api_response"] | None: ...
