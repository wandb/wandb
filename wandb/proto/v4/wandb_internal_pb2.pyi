...
class _ServerFeatureEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ServerFeature.ValueType], builtins.type):
    ...
    url.
    """
    USE_ARTIFACT_WITH_COLLECTION_INFORMATION: _ServerFeature.ValueType  # 7
    """Indicates that the server supports passing the artifact name to the useArtifact mutation."""
...
url.
"""
USE_ARTIFACT_WITH_COLLECTION_INFORMATION: ServerFeature.ValueType  # 7
"""Indicates that the server supports passing the artifact name to the useArtifact mutation."""
