...
class RunExitRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_info", b"_info", "exit_code", b"exit_code", "marked_preempting", b"marked_preempting", "runtime", b"runtime"]) -> None: ...
...
class OperationStats(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["label", b"label", "operations", b"operations", "total_operations", b"total_operations"]) -> None: ...
