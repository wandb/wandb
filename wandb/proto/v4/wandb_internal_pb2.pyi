...
class _ServerFeatureEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ServerFeature.ValueType], builtins.type):
    ...
    AUTOMATION_EVENT_RUN_METRIC: _ServerFeature.ValueType  # 8
    """Indicates that the server supports automation event RUN_METRIC."""
    AUTOMATION_EVENT_RUN_METRIC_CHANGE: _ServerFeature.ValueType  # 9
    """Indicates that the server supports automation event RUN_METRIC_CHANGE."""
    AUTOMATION_ACTION_NO_OP: _ServerFeature.ValueType  # 10
...
"""Indicates that the server supports passing the artifact's entity and project to the useArtifact mutation."""
AUTOMATION_EVENT_RUN_METRIC: ServerFeature.ValueType  # 8
"""Indicates that the server supports automation event RUN_METRIC."""
AUTOMATION_EVENT_RUN_METRIC_CHANGE: ServerFeature.ValueType  # 9
"""Indicates that the server supports automation event RUN_METRIC_CHANGE."""
AUTOMATION_ACTION_NO_OP: ServerFeature.ValueType  # 10
"""Indicates that the server supports automation action NO_OP."""
