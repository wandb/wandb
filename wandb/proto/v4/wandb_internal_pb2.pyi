...
class RunRecord(google.protobuf.message.Message):
    ...
    RUNQUEUE_ITEM_ID_FIELD_NUMBER: builtins.int
    _INFO_FIELD_NUMBER: builtins.int
    run_id: builtins.str
    entity: builtins.str
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_info", b"_info", "config", b"config", "display_name", b"display_name", "entity", b"entity", "git", b"git", "host", b"host", "job_type", b"job_type", "notes", b"notes", "project", b"project", "resumed", b"resumed", "run_group", b"run_group", "run_id", b"run_id", "runqueue_item_id", b"runqueue_item_id", "runtime", b"runtime", "settings", b"settings", "start_time", b"start_time", "starting_step", b"starting_step", "storage_id", b"storage_id", "summary", b"summary", "sweep_id", b"sweep_id", "tags", b"tags", "telemetry", b"telemetry"]) -> None: ...
