...
class Settings(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_fork_from", b"_fork_from"]) -> typing_extensions.Literal["fork_from"] | None: ...
