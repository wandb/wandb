...
class Settings(google.protobuf.message.Message):
    ...
    @property
    def import_mode(self) -> google.protobuf.wrappers_pb2.BoolValue: ...
    def __init__(
        self,
        *,
