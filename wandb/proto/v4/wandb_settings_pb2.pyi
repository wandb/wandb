...
class Settings(google.protobuf.message.Message):
    ...
    X_STATS_GPU_INDICES_FIELD_NUMBER: builtins.int
    ...
    @property
    def x_stats_gpu_indices(self) -> global___ListIntValue:
    ...
    def __init__(
        ...
        *,
        ...
        x_stats_gpu_indices: global___ListIntValue | None = ...,
