...
@typing_extensions.final
class SystemMonitorSettings(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    _PID_FIELD_NUMBER: builtins.int
    SAMPLING_INTERVAL_SECONDS_FIELD_NUMBER: builtins.int
    SAMPLES_TO_AVERAGE_FIELD_NUMBER: builtins.int
    NEURON_MONITOR_CONFIG_PATH_FIELD_NUMBER: builtins.int
    OPEN_METRICS_ENDPOINTS_FIELD_NUMBER: builtins.int
    OPEN_METRICS_FILTERS_FIELD_NUMBER: builtins.int
    DISK_PATHS_FIELD_NUMBER: builtins.int
    @property
    def _pid(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    def sampling_interval_seconds(self) -> google.protobuf.wrappers_pb2.DoubleValue: ...
    @property
    def samples_to_average(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    def neuron_monitor_config_path(self) -> google.protobuf.wrappers_pb2.StringValue: ...
    @property
    def open_metrics_endpoints(self) -> global___MapStringKeyStringValue: ...
    @property
    def open_metrics_filters(self) -> global___OpenMetricsFilters: ...
    @property
    def disk_paths(self) -> global___ListStringValue: ...
    def __init__(
        self,
        *,
        _pid: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        sampling_interval_seconds: google.protobuf.wrappers_pb2.DoubleValue | None = ...,
        samples_to_average: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        neuron_monitor_config_path: google.protobuf.wrappers_pb2.StringValue | None = ...,
        open_metrics_endpoints: global___MapStringKeyStringValue | None = ...,
        open_metrics_filters: global___OpenMetricsFilters | None = ...,
        disk_paths: global___ListStringValue | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_pid", b"_pid", "disk_paths", b"disk_paths", "neuron_monitor_config_path", b"neuron_monitor_config_path", "open_metrics_endpoints", b"open_metrics_endpoints", "open_metrics_filters", b"open_metrics_filters", "samples_to_average", b"samples_to_average", "sampling_interval_seconds", b"sampling_interval_seconds"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_pid", b"_pid", "disk_paths", b"disk_paths", "neuron_monitor_config_path", b"neuron_monitor_config_path", "open_metrics_endpoints", b"open_metrics_endpoints", "open_metrics_filters", b"open_metrics_filters", "samples_to_average", b"samples_to_average", "sampling_interval_seconds", b"sampling_interval_seconds"]) -> None: ...

global___SystemMonitorSettings = SystemMonitorSettings
...
class Settings(google.protobuf.message.Message):
    ...
    _FILE_UPLOADER_RETRY_MAX_FIELD_NUMBER: builtins.int
    _FILE_UPLOADER_RETRY_WAIT_MIN_SECONDS_FIELD_NUMBER: builtins.int
    _FILE_UPLOADER_RETRY_WAIT_MAX_SECONDS_FIELD_NUMBER: builtins.int
    _FILE_UPLOADER_TIMEOUT_SECONDS_FIELD_NUMBER: builtins.int
    ...
    SYSTEM_MONITOR_FIELD_NUMBER: builtins.int
    ...
    @property
    def _file_stream_retry_wait_min_seconds(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    def _file_stream_retry_wait_max_seconds(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    def _file_stream_timeout_seconds(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    def _file_uploader_retry_max(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    def _file_uploader_retry_wait_min_seconds(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    def _file_uploader_retry_wait_max_seconds(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    def _file_uploader_timeout_seconds(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    ...
    @property
    def _graphql_retry_wait_min_seconds(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    def _graphql_retry_wait_max_seconds(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    def _graphql_timeout_seconds(self) -> google.protobuf.wrappers_pb2.Int32Value: ...
    @property
    ...
    @property
    def system_monitor(self) -> global___SystemMonitorSettings: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        _file_stream_retry_wait_min_seconds: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        _file_stream_retry_wait_max_seconds: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        _file_stream_timeout_seconds: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        _file_uploader_retry_max: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        _file_uploader_retry_wait_min_seconds: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        _file_uploader_retry_wait_max_seconds: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        _file_uploader_timeout_seconds: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        ...
        _graphql_retry_wait_min_seconds: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        _graphql_retry_wait_max_seconds: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        _graphql_timeout_seconds: google.protobuf.wrappers_pb2.Int32Value | None = ...,
        ...
        system_monitor: global___SystemMonitorSettings | None = ...,
