...
class RunMoment(google.protobuf.message.Message):
    ...
    VALUE_FIELD_NUMBER: builtins.int
    @property
    def run(self) -> google.protobuf.wrappers_pb2.StringValue: ...
    @property
    def value(self) -> google.protobuf.wrappers_pb2.DoubleValue: ...
    def __init__(
        self,
        *,
        run: google.protobuf.wrappers_pb2.StringValue | None = ...,
        value: google.protobuf.wrappers_pb2.DoubleValue | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["run", b"run", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["run", b"run", "value", b"value"]) -> None: ...
