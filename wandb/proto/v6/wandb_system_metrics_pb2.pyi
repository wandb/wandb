...
class MetricInfo(_message.Message):
    ...
    range_min: float
    range_max: float
    def __init__(self, unit: _Optional[str] = ..., display: _Optional[str] = ..., kind: _Optional[_Union[MetricInfo.Kind, str]] = ..., legacy: _Optional[_Iterable[_Union[LegacyKey, _Mapping]]] = ..., legacy_process_copy: bool = ..., range_min: _Optional[float] = ..., range_max: _Optional[float] = ...) -> None: ...
...
class SystemMetricsRecord(_message.Message):
    ...
    def __init__(self, timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., writer_id: _Optional[str] = ..., label: _Optional[str] = ..., host: _Optional[_Union[HostMetrics, _Mapping]] = ..., process: _Optional[_Union[ProcessMetrics, _Mapping]] = ..., accelerators: _Optional[_Iterable[_Union[AcceleratorMetrics, _Mapping]]] = ..., tpu_runtime: _Optional[_Union[TpuRuntimeMetrics, _Mapping]] = ..., trainium_host: _Optional[_Union[TrainiumHostMetrics, _Mapping]] = ..., generic: _Optional[_Iterable[_Union[GenericMetric, _Mapping]]] = ..., _info: _Optional[_Union[_wandb_base_pb2._RecordInfo, _Mapping]] = ...) -> None: ...
