...
class ServerRequest(_message.Message):
    __slots__ = ("request_id", "cancel", "record_publish", "record_communicate", "inform_init", "inform_finish", "inform_attach", "inform_detach", "inform_teardown", "init_sync", "sync", "sync_status", "api_init_request", "api_cleanup_request", "api_request")
    REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
