...
class MetricSummary(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["best", b"best", "copy", b"copy", "first", b"first", "last", b"last", "max", b"max", "mean", b"mean", "min", b"min", "none", b"none"]) -> None: ...
...
class Request(google.protobuf.message.Message):
    ...
    **********************
    ...
    COREWEAVE_METADATA_FIELD_NUMBER: builtins.int
    ...
    @property
    def coreweave_metadata(self) -> global___ProbeCoreWeaveMetadataRequest:
        """Requests the system monitor to attempt capturing metadata about the compute environment
...
@typing.final
class ProbeCoreWeaveMetadataRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ProbeCoreWeaveMetadataRequest = ProbeCoreWeaveMetadataRequest
