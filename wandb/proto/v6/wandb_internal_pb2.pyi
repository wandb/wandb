...
class Record(_message.Message):
    __slots__ = ("num", "history", "summary", "output", "config", "files", "stats", "artifact", "tbrecord", "alert", "telemetry", "metric", "output_raw", "run", "exit", "final", "header", "footer", "preempting", "noop_link_artifact", "use_artifact", "environment", "output_logger", "device_binding", "request", "control", "uuid", "_info")
...
class GpuNvidiaInfo(_message.Message):
    __slots__ = ("name", "memory_total", "cuda_cores", "architecture", "uuid", "pci_bus_id", "serial")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    pci_bus_id: str
    serial: str
    def __init__(self, name: _Optional[str] = ..., memory_total: _Optional[int] = ..., cuda_cores: _Optional[int] = ..., architecture: _Optional[str] = ..., uuid: _Optional[str] = ..., pci_bus_id: _Optional[str] = ..., serial: _Optional[str] = ...) -> None: ...
