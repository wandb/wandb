...
class Request(_message.Message):
    __slots__ = ("stop_status", "network_status", "defer", "get_summary", "login", "pause", "resume", "poll_exit", "sampled_history", "partial_history", "history_step", "run_start", "check_version", "log_artifact", "download_artifact", "keepalive", "run_status", "cancel", "internal_messages", "python_packages", "shutdown", "attach", "status", "server_info", "sender_mark", "sender_read", "status_report", "summary_record", "telemetry_record", "job_info", "get_system_metrics", "job_input", "link_artifact", "sync_finish", "run_log", "operations", "probe_system_info", "test_inject")
...
class RunLogRequest(_message.Message):
    __slots__ = ("line", "label", "level", "_info")
    class Level(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        INFO: _ClassVar[RunLogRequest.Level]
        ERROR: _ClassVar[RunLogRequest.Level]
    INFO: RunLogRequest.Level
    ERROR: RunLogRequest.Level
    LINE_FIELD_NUMBER: _ClassVar[int]
    LABEL_FIELD_NUMBER: _ClassVar[int]
    LEVEL_FIELD_NUMBER: _ClassVar[int]
    _INFO_FIELD_NUMBER: _ClassVar[int]
    line: str
    label: str
    level: RunLogRequest.Level
    _info: _wandb_base_pb2._RequestInfo
    def __init__(self, line: _Optional[str] = ..., label: _Optional[str] = ..., level: _Optional[_Union[RunLogRequest.Level, str]] = ..., _info: _Optional[_Union[_wandb_base_pb2._RequestInfo, _Mapping]] = ...) -> None: ...
