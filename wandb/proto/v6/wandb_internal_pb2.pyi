...
class Control(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["always_send", b"always_send", "connection_id", b"connection_id", "end_offset", b"end_offset", "flow_control", b"flow_control", "local", b"local", "mailbox_slot", b"mailbox_slot", "relay_id", b"relay_id", "req_resp", b"req_resp"]) -> None: ...
...
class Result(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info", "config_result", b"config_result", "control", b"control", "exit_result", b"exit_result", "log_result", b"log_result", "output_result", b"output_result", "response", b"response", "result_type", b"result_type", "run_result", b"run_result", "summary_result", b"summary_result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "config_result", b"config_result", "control", b"control", "exit_result", b"exit_result", "log_result", b"log_result", "output_result", b"output_result", "response", b"response", "result_type", b"result_type", "run_result", b"run_result", "summary_result", b"summary_result", "uuid", b"uuid"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["result_type", b"result_type"]) -> typing.Literal["run_result", "exit_result", "log_result", "summary_result", "output_result", "config_result", "response"] | None: ...
...
class VersionInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "min_consumer", b"min_consumer", "producer", b"producer"]) -> None: ...
...
class HeaderRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info", "version_info", b"version_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "version_info", b"version_info"]) -> None: ...
...
class GitRepoRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["commit", b"commit", "remote_url", b"remote_url"]) -> None: ...
...
class RunUpdateResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["error", b"error", "run", b"run"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["error", b"error", "run", b"run"]) -> None: ...
...
class RunExitRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "exit_code", b"exit_code", "runtime", b"runtime"]) -> None: ...
...
class SettingsRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "item", b"item"]) -> None: ...
...
class HistoryRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info", "step", b"step"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "item", b"item", "step", b"step"]) -> None: ...
...
class OutputRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info", "timestamp", b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "line", b"line", "output_type", b"output_type", "timestamp", b"timestamp"]) -> None: ...
...
class MetricOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["defined", b"defined", "hidden", b"hidden", "step_sync", b"step_sync"]) -> None: ...
...
class MetricControl(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["overwrite", b"overwrite"]) -> None: ...
...
class MetricSummary(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["best", b"best", "copy", b"copy", "last", b"last", "max", b"max", "mean", b"mean", "min", b"min", "none", b"none"]) -> None: ...
...
class ConfigRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "remove", b"remove", "update", b"update"]) -> None: ...
...
class FilesRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "files", b"files"]) -> None: ...
...
class FilesItem(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["path", b"path", "policy", b"policy", "type", b"type"]) -> None: ...
...
class StatsRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info", "timestamp", b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "item", b"item", "stats_type", b"stats_type", "timestamp", b"timestamp"]) -> None: ...
...
class ArtifactManifestEntry(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["birth_artifact_id", b"birth_artifact_id", "digest", b"digest", "extra", b"extra", "local_path", b"local_path", "mimetype", b"mimetype", "path", b"path", "ref", b"ref", "size", b"size", "skip_cache", b"skip_cache"]) -> None: ...
...
class LinkArtifactRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "client_id", b"client_id", "portfolio_aliases", b"portfolio_aliases", "portfolio_entity", b"portfolio_entity", "portfolio_name", b"portfolio_name", "portfolio_organization", b"portfolio_organization", "portfolio_project", b"portfolio_project", "server_id", b"server_id"]) -> None: ...
...
class TBRecord(google.protobuf.message.Message):
    ...
    * A tfevents value tagged "epoch_loss" is logged as "train/epoch_loss"
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "log_dir", b"log_dir", "root_dir", b"root_dir", "save", b"save"]) -> None: ...
...
class AlertRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "level", b"level", "text", b"text", "title", b"title", "wait_duration", b"wait_duration"]) -> None: ...
...
class Request(google.protobuf.message.Message):
    ...
    **********************
    ...
    def WhichOneof(self, oneof_group: typing.Literal["request_type", b"request_type"]) -> typing.Literal["stop_status", "network_status", "defer", "get_summary", "login", "pause", "resume", "poll_exit", "sampled_history", "partial_history", "run_start", "check_version", "log_artifact", "download_artifact", "keepalive", "server_feature", "run_status", "cancel", "internal_messages", "python_packages", "shutdown", "attach", "status", "server_info", "sender_mark", "sender_read", "status_report", "summary_record", "telemetry_record", "job_info", "get_system_metrics", "job_input", "link_artifact", "run_finish_without_exit", "get_system_metadata", "sync_finish", "operations", "test_inject"] | None: ...
...
class LoginRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "api_key", b"api_key"]) -> None: ...
...
class LoginResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["active_entity", b"active_entity"]) -> None: ...
...
class StatusResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["run_should_stop", b"run_should_stop"]) -> None: ...
...
class NetworkStatusResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["network_responses", b"network_responses"]) -> None: ...
...
class HttpResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["http_response_text", b"http_response_text", "http_status_code", b"http_status_code"]) -> None: ...
...
class InternalMessagesResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["messages", b"messages"]) -> builtins.bool: ...
...
class InternalMessages(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["warning", b"warning"]) -> None: ...
...
class PollExitResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["exit_result", b"exit_result", "file_counts", b"file_counts", "operation_stats", b"operation_stats", "pusher_stats", b"pusher_stats"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["done", b"done", "exit_result", b"exit_result", "file_counts", b"file_counts", "operation_stats", b"operation_stats", "pusher_stats", b"pusher_stats"]) -> None: ...
...
class Operation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["desc", b"desc", "error_status", b"error_status", "progress", b"progress", "runtime_seconds", b"runtime_seconds", "subtasks", b"subtasks"]) -> None: ...
...
class SyncResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["error", b"error", "url", b"url"]) -> None: ...
...
class SenderReadRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["final_offset", b"final_offset", "start_offset", b"start_offset"]) -> None: ...
...
class StatusReportRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["sync_time", b"sync_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["record_num", b"record_num", "sent_offset", b"sent_offset", "sync_time", b"sync_time"]) -> None: ...
...
class ServerInfoResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["local_info", b"local_info", "server_messages", b"server_messages"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["local_info", b"local_info", "server_messages", b"server_messages"]) -> None: ...
...
class ServerMessage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["html_text", b"html_text", "level", b"level", "plain_text", b"plain_text", "type", b"type", "utf_text", b"utf_text"]) -> None: ...
...
class FileCounts(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["artifact_count", b"artifact_count", "media_count", b"media_count", "other_count", b"other_count", "wandb_count", b"wandb_count"]) -> None: ...
...
class FilePusherStats(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["deduped_bytes", b"deduped_bytes", "total_bytes", b"total_bytes", "uploaded_bytes", b"uploaded_bytes"]) -> None: ...
...
class FileTransferInfoRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["file_counts", b"file_counts"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["file_counts", b"file_counts", "path", b"path", "processed", b"processed", "size", b"size", "type", b"type", "url", b"url"]) -> None: ...
...
class LocalInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["out_of_date", b"out_of_date", "version", b"version"]) -> None: ...
...
class AttachRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "attach_id", b"attach_id"]) -> None: ...
...
class HistoryAction(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["flush", b"flush"]) -> None: ...
...
class PartialHistoryRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info", "action", b"action", "step", b"step"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "action", b"action", "item", b"item", "step", b"step"]) -> None: ...
...
class SampledHistoryItem(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["key", b"key", "nested_key", b"nested_key", "values_float", b"values_float", "values_int", b"values_int"]) -> None: ...
...
class RunStatusResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["sync_time", b"sync_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["sync_items_pending", b"sync_items_pending", "sync_items_total", b"sync_items_total", "sync_time", b"sync_time"]) -> None: ...
...
class RunStartRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info", "run", b"run"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "run", b"run"]) -> None: ...
...
class CheckVersionRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "current_version", b"current_version"]) -> None: ...
...
class CheckVersionResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["delete_message", b"delete_message", "upgrade_message", b"upgrade_message", "yank_message", b"yank_message"]) -> None: ...
...
class JobInfoResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["sequenceId", b"sequenceId", "version", b"version"]) -> None: ...
...
class LogArtifactRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info", "artifact", b"artifact"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "artifact", b"artifact", "history_step", b"history_step", "staging_dir", b"staging_dir"]) -> None: ...
...
class LogArtifactResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["artifact_id", b"artifact_id", "error_message", b"error_message"]) -> None: ...
...
class DownloadArtifactRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "allow_missing_references", b"allow_missing_references", "artifact_id", b"artifact_id", "download_root", b"download_root", "path_prefix", b"path_prefix", "skip_cache", b"skip_cache"]) -> None: ...
...
class ArtifactInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["artifact", b"artifact", "build_context", b"build_context", "dockerfile", b"dockerfile", "entrypoint", b"entrypoint", "notebook", b"notebook"]) -> None: ...
...
class GitInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["commit", b"commit", "remote", b"remote"]) -> None: ...
...
class GitSource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["git_info", b"git_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["build_context", b"build_context", "dockerfile", b"dockerfile", "entrypoint", b"entrypoint", "git_info", b"git_info", "notebook", b"notebook"]) -> None: ...
...
class Source(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["artifact", b"artifact", "git", b"git", "image", b"image"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["artifact", b"artifact", "git", b"git", "image", b"image"]) -> None: ...
...
class JobSource(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_version", b"_version", "runtime", b"runtime", "source", b"source", "source_type", b"source_type"]) -> None: ...
...
class PartialJobArtifact(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["source_info", b"source_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["job_name", b"job_name", "source_info", b"source_info"]) -> None: ...
...
class UseArtifactRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info", "partial", b"partial"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "id", b"id", "name", b"name", "partial", b"partial", "type", b"type"]) -> None: ...
...
class CancelRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "cancel_slot", b"cancel_slot"]) -> None: ...
...
class DiskInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["total", b"total", "used", b"used"]) -> None: ...
...
class CpuInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["count", b"count", "count_logical", b"count_logical"]) -> None: ...
...
class GpuNvidiaInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["architecture", b"architecture", "cuda_cores", b"cuda_cores", "memory_total", b"memory_total", "name", b"name", "uuid", b"uuid"]) -> None: ...
...
class TPUInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["count", b"count", "devices_per_chip", b"devices_per_chip", "hbm_gib", b"hbm_gib", "name", b"name"]) -> None: ...
...
class Metadata(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["apple", b"apple", "coreweave", b"coreweave", "cpu", b"cpu", "git", b"git", "heartbeat_at", b"heartbeat_at", "memory", b"memory", "started_at", b"started_at", "tpu", b"tpu", "trainium", b"trainium"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["apple", b"apple", "args", b"args", "code_path", b"code_path", "code_path_local", b"code_path_local", "colab", b"colab", "coreweave", b"coreweave", "cpu", b"cpu", "cpu_count", b"cpu_count", "cpu_count_logical", b"cpu_count_logical", "cuda", b"cuda", "cuda_version", b"cuda_version", "disk", b"disk", "docker", b"docker", "email", b"email", "executable", b"executable", "git", b"git", "gpu_amd", b"gpu_amd", "gpu_count", b"gpu_count", "gpu_nvidia", b"gpu_nvidia", "gpu_type", b"gpu_type", "heartbeat_at", b"heartbeat_at", "host", b"host", "memory", b"memory", "os", b"os", "program", b"program", "python", b"python", "root", b"root", "slurm", b"slurm", "started_at", b"started_at", "state", b"state", "tpu", b"tpu", "trainium", b"trainium", "username", b"username"]) -> None: ...
...
class MetadataRecord(google.protobuf.message.Message):
    ...
    """Flag indicating whether the record originated from the user."""
    @property
    def metadata(self) -> global___Metadata: ...
    @property
    def _info(self) -> wandb.proto.wandb_base_pb2._RecordInfo: ...
    ...
    def HasField(self, field_name: typing.Literal["X_user_modified", b"X_user_modified", "_info", b"_info", "_user_modified", b"_user_modified", "metadata", b"metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["X_user_modified", b"X_user_modified", "_info", b"_info", "_user_modified", b"_user_modified", "metadata", b"metadata"]) -> None: ...
...
class JobInputSource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["file", b"file", "run_config", b"run_config", "source", b"source"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["file", b"file", "run_config", b"run_config", "source", b"source"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["source", b"source"]) -> typing.Literal["run_config", "file"] | None: ...
