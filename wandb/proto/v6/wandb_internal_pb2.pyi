...
class MetadataRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "metadata", b"metadata"]) -> None: ...
