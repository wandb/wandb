...
class Request(_message.Message):
    ...
    **********************
    ...
    SERVER_FEATURE_FIELD_NUMBER: _builtins.int
    ...
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    _WhichOneofReturnType_request_type: _TypeAlias = _typing.Literal["stop_status", "network_status", "defer", "get_summary", "login", "pause", "resume", "poll_exit", "sampled_history", "partial_history", "run_start", "check_version", "log_artifact", "download_artifact", "keepalive", "server_feature", "run_status", "cancel", "internal_messages", "python_packages", "shutdown", "attach", "status", "server_info", "sender_mark", "sender_read", "status_report", "summary_record", "telemetry_record", "job_info", "get_system_metrics", "job_input", "link_artifact", "run_finish_without_exit", "sync_finish", "operations", "probe_system_info", "test_inject"]  # noqa: Y015
...
class Response(_message.Message):
    ...
    SERVER_FEATURE_RESPONSE_FIELD_NUMBER: _builtins.int
...
@_typing.final
class ServerFeatureRequest(_message.Message):
    """*
    ...
    _HasFieldArgType: _TypeAlias = _typing.Literal["_info", b"_info"]  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["_info", b"_info", "feature", b"feature"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___ServerFeatureRequest: _TypeAlias = ServerFeatureRequest  # noqa: Y015

@_typing.final
class ServerFeatureResponse(_message.Message):
    """*
...
Global___ServerFeatureResponse: _TypeAlias = ServerFeatureResponse  # noqa: Y015

@_typing.final
class ServerFeatureItem(_message.Message):
    """*
...
Global___ServerFeatureItem: _TypeAlias = ServerFeatureItem  # noqa: Y015
