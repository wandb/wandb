...
class Deprecated(google.protobuf.message.Message):
    ...
    LANGCHAIN_TRACER_FIELD_NUMBER: builtins.int
    KERAS_CALLBACK__LOG_GRADIENTS_FIELD_NUMBER: builtins.int
    ...
    keras_callback__log_gradients: builtins.bool
    """wandb.keras.WandbCallback(log_gradients=True) called for tf 2.14.0"""
    def __init__(
        self,
        *,
        keras_callback__data_type: builtins.bool = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["init__config_exclude_keys", b"init__config_exclude_keys", "init__config_include_keys", b"init__config_include_keys", "keras_callback__data_type", b"keras_callback__data_type", "keras_callback__log_gradients", b"keras_callback__log_gradients", "keras_callback__save_model", b"keras_callback__save_model", "langchain_tracer", b"langchain_tracer", "plots", b"plots", "run__join", b"run__join", "run__log_sync", b"run__log_sync", "run__mode", b"run__mode", "run__save_no_args", b"run__save_no_args"]) -> None: ...
