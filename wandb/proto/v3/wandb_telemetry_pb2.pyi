...
class Issues(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["data_types__video_fps", b"data_types__video_fps", "settings__preprocessing_warnings", b"settings__preprocessing_warnings", "settings__unexpected_args", b"settings__unexpected_args", "settings__validation_warnings", b"settings__validation_warnings"]) -> None: ...
