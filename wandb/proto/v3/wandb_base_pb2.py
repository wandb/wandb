...
__RECORDINFO_HEADERSENTRY = __RECORDINFO.nested_types_by_name['HeadersEntry']
...
_RecordInfo = _reflection.GeneratedProtocolMessageType('_RecordInfo', (_message.Message,), {
  ...
  'HeadersEntry' : _reflection.GeneratedProtocolMessageType('HeadersEntry', (_message.Message,), {
    'DESCRIPTOR' : __RECORDINFO_HEADERSENTRY,
    '__module__' : 'wandb.proto.wandb_base_pb2'
    # @@protoc_insertion_point(class_scope:wandb_internal._RecordInfo.HeadersEntry)
    })
  ,
...
_sym_db.RegisterMessage(_RecordInfo.HeadersEntry)
