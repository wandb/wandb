...
class Settings(google.protobuf.message.Message):
    ...
    _IMPORT_MODE_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def _import_mode(self) -> google.protobuf.wrappers_pb2.BoolValue: ...
    def __init__(
        self,
        *,
