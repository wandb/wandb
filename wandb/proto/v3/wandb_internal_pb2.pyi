...
class ServerFeatureRequest(google.protobuf.message.Message):
    ...
    *
    ServerFeatureRequest: request to the backend server for the features it supports.
    including the details of the feature provided by the server.
    """
    ...
    def HasField(self, field_name: typing_extensions.Literal["_info", b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_info", b"_info", "features", b"features"]) -> None: ...

global___ServerFeatureRequest = ServerFeatureRequest

class ServerFeatureResponse(google.protobuf.message.Message):
    """*
    ServerFeatureResponse: response from the backend server for the features it
    supports. including the details of the feature provided by the server.
    """
...
class ServerFeatureItem(google.protobuf.message.Message):
    """*
    ServerFeatureItem: details of a feature provided by the server.
    """
    ...
    def ClearField(self, field_name: typing_extensions.Literal["default_value", b"default_value", "description", b"description", "enabled", b"enabled", "name", b"name"]) -> None: ...
