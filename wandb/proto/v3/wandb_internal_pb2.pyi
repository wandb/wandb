...
class RunRecord(google.protobuf.message.Message):
    ...
    RUN_QUEUE_ITEM_ID_FIELD_NUMBER: builtins.int
    _INFO_FIELD_NUMBER: builtins.int
    run_id: builtins.str
    entity: builtins.str
    ...
    run_queue_item_id: builtins.str
    @property
    def _info(self) -> wandb.proto.wandb_base_pb2._RecordInfo: ...
    def __init__(
        self,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_info", b"_info", "config", b"config", "display_name", b"display_name", "entity", b"entity", "git", b"git", "host", b"host", "job_type", b"job_type", "notes", b"notes", "project", b"project", "resumed", b"resumed", "run_group", b"run_group", "run_id", b"run_id", "run_queue_item_id", b"run_queue_item_id", "runtime", b"runtime", "settings", b"settings", "start_time", b"start_time", "starting_step", b"starting_step", "storage_id", b"storage_id", "summary", b"summary", "sweep_id", b"sweep_id", "tags", b"tags", "telemetry", b"telemetry"]) -> None: ...
