...
class DataValue(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["data_type", b"data_type", "value_double", b"value_double", "value_int", b"value_int", "value_string", b"value_string", "value_tensor", b"value_tensor"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data_type", b"data_type", "value_double", b"value_double", "value_int", b"value_int", "value_string", b"value_string", "value_tensor", b"value_tensor"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["data_type", b"data_type"]) -> typing_extensions.Literal["value_int", "value_double", "value_string", "value_tensor"] | None: ...
