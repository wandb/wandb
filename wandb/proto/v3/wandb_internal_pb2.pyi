...
class Response(google.protobuf.message.Message):
    ...
    SENDER_READ_RESPONSE_FIELD_NUMBER: builtins.int
    ...
    @property
    def sender_read_response(self) -> global___SenderReadResponse: ...
    @property
