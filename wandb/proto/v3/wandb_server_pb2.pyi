...
class StringTupleValue(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["string_values", b"string_values"]
    ) -> None: ...
...
class StringStringMapValue(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["map_values", b"map_values"]
    ) -> None: ...
...
class ServerInformInitRequest(google.protobuf.message.Message):
    ...
    def _settings_map(
        ...
        builtins.str, global___SettingsValue
    ]: ...
    @property
    def _info(self) -> wandb.proto.wandb_base_pb2._RecordInfo: ...
    def __init__(
        self,
        *,
        _settings_map: collections.abc.Mapping[builtins.str, global___SettingsValue]
        | None = ...,
        _info: wandb.proto.wandb_base_pb2._RecordInfo | None = ...,
    ) -> None: ...
    def HasField(
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "_info", b"_info", "_settings_map", b"_settings_map"
        ],
    ) -> None: ...
