...
class Control(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"local",b"local",u"relay_id",b"relay_id",u"req_resp",b"req_resp"]) -> None: ...
...
class GitRepoRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"last_commit",b"last_commit",u"remote_url",b"remote_url"]) -> None: ...
...
class Request(google.protobuf.message.Message):
    ...
    PROPOSE_INTENT_DONE_FIELD_NUMBER: builtins.int
    RECALL_INTENT_DONE_FIELD_NUMBER: builtins.int
    SHUTDOWN_FIELD_NUMBER: builtins.int
    ATTACH_FIELD_NUMBER: builtins.int
    STATUS_FIELD_NUMBER: builtins.int
    PROPOSE_INTENT_FIELD_NUMBER: builtins.int
    RECALL_INTENT_FIELD_NUMBER: builtins.int
    INSPECT_INTENT_FIELD_NUMBER: builtins.int
    ...
    @property
    def propose_intent_done(self) -> global___ProposeIntentDoneRequest: ...

    @property
    def recall_intent_done(self) -> global___RecallIntentDoneRequest: ...
    ...
    @property
    def propose_intent(self) -> global___ProposeIntentRequest: ...

    @property
    def recall_intent(self) -> global___RecallIntentRequest: ...

    @property
    def inspect_intent(self) -> global___InspectIntentRequest: ...
    ...
    def __init__(self,
        *,
        ...
        propose_intent_done : typing.Optional[global___ProposeIntentDoneRequest] = ...,
        recall_intent_done : typing.Optional[global___RecallIntentDoneRequest] = ...,
        ...
        propose_intent : typing.Optional[global___ProposeIntentRequest] = ...,
        recall_intent : typing.Optional[global___RecallIntentRequest] = ...,
        inspect_intent : typing.Optional[global___InspectIntentRequest] = ...,
        test_inject : typing.Optional[global___TestInjectRequest] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"artifact_done",b"artifact_done",u"artifact_poll",b"artifact_poll",u"artifact_send",b"artifact_send",u"attach",b"attach",u"check_version",b"check_version",u"defer",b"defer",u"get_summary",b"get_summary",u"inspect_intent",b"inspect_intent",u"log_artifact",b"log_artifact",u"login",b"login",u"network_status",b"network_status",u"partial_history",b"partial_history",u"pause",b"pause",u"poll_exit",b"poll_exit",u"propose_intent",b"propose_intent",u"propose_intent_done",b"propose_intent_done",u"recall_intent",b"recall_intent",u"recall_intent_done",b"recall_intent_done",u"request_type",b"request_type",u"resume",b"resume",u"run_start",b"run_start",u"sampled_history",b"sampled_history",u"shutdown",b"shutdown",u"status",b"status",u"stop_status",b"stop_status",u"test_inject",b"test_inject"]) -> builtins.bool: ...
...
class Response(google.protobuf.message.Message):
    ...
    PROPOSE_INTENT_RESPONSE_FIELD_NUMBER: builtins.int
    RECALL_INTENT_RESPONSE_FIELD_NUMBER: builtins.int
    INSPECT_INTENT_RESPONSE_FIELD_NUMBER: builtins.int
    ...
    @property
    def propose_intent_response(self) -> global___ProposeIntentResponse: ...

    @property
    def recall_intent_response(self) -> global___RecallIntentResponse: ...

    @property
    def inspect_intent_response(self) -> global___InspectIntentResponse: ...
    ...
    def __init__(self,
        *,
        ...
        propose_intent_response : typing.Optional[global___ProposeIntentResponse] = ...,
        recall_intent_response : typing.Optional[global___RecallIntentResponse] = ...,
        inspect_intent_response : typing.Optional[global___InspectIntentResponse] = ...,
        test_inject_response : typing.Optional[global___TestInjectResponse] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"artifact_poll_response",b"artifact_poll_response",u"artifact_send_response",b"artifact_send_response",u"attach_response",b"attach_response",u"check_version_response",b"check_version_response",u"get_summary_response",b"get_summary_response",u"inspect_intent_response",b"inspect_intent_response",u"log_artifact_response",b"log_artifact_response",u"login_response",b"login_response",u"network_status_response",b"network_status_response",u"poll_exit_response",b"poll_exit_response",u"propose_intent_response",b"propose_intent_response",u"recall_intent_response",b"recall_intent_response",u"response_type",b"response_type",u"run_start_response",b"run_start_response",u"sampled_history_response",b"sampled_history_response",u"shutdown_response",b"shutdown_response",u"status_response",b"status_response",u"stop_status_response",b"stop_status_response",u"test_inject_response",b"test_inject_response"]) -> builtins.bool: ...
...
class IntentDefinition(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    RUN_FIELD_NUMBER: builtins.int
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"intent_type",b"intent_type",u"run",b"run"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"intent_type",b"intent_type",u"run",b"run"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"intent_type",b"intent_type"]) -> typing_extensions.Literal["run"]: ...
global___IntentDefinition = IntentDefinition

class IntentOutcome(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    RUN_RESULT_FIELD_NUMBER: builtins.int
    ERROR_FIELD_NUMBER: builtins.int
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"intent_outcome_type",b"intent_outcome_type",u"run_result",b"run_result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"error",b"error",u"intent_outcome_type",b"intent_outcome_type",u"is_resolved",b"is_resolved",u"run_result",b"run_result"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"intent_outcome_type",b"intent_outcome_type"]) -> typing_extensions.Literal["run_result"]: ...
global___IntentOutcome = IntentOutcome

class ProposeIntentRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    INTENT_ID_FIELD_NUMBER: builtins.int
    INTENT_FIELD_NUMBER: builtins.int
    intent_id: typing.Text = ...

    @property
    def intent(self) -> global___IntentDefinition: ...

    def __init__(self,
        *,
        intent_id : typing.Text = ...,
        intent : typing.Optional[global___IntentDefinition] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"intent",b"intent"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"intent",b"intent",u"intent_id",b"intent_id"]) -> None: ...
global___ProposeIntentRequest = ProposeIntentRequest

class ProposeIntentResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ERROR_FIELD_NUMBER: builtins.int
    ...
    @property
    def outcome(self) -> global___IntentOutcome: ...

    def __init__(self,
        *,
        error : typing.Text = ...,
        outcome : typing.Optional[global___IntentOutcome] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"outcome",b"outcome"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"error",b"error",u"outcome",b"outcome"]) -> None: ...
global___ProposeIntentResponse = ProposeIntentResponse

class ProposeIntentDoneRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    INTENT_ID_FIELD_NUMBER: builtins.int
    OUTCOME_FIELD_NUMBER: builtins.int
    intent_id: typing.Text = ...
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"outcome",b"outcome"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"intent_id",b"intent_id",u"outcome",b"outcome"]) -> None: ...
global___ProposeIntentDoneRequest = ProposeIntentDoneRequest

class RecallIntentRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    INTENT_ID_FIELD_NUMBER: builtins.int
    intent_id: typing.Text = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"intent_id",b"intent_id"]) -> None: ...
global___RecallIntentRequest = RecallIntentRequest

class RecallIntentResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...

    def __init__(self,
        ) -> None: ...
global___RecallIntentResponse = RecallIntentResponse

class RecallIntentDoneRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    INTENT_ID_FIELD_NUMBER: builtins.int
    intent_id: typing.Text = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"intent_id",b"intent_id"]) -> None: ...
global___RecallIntentDoneRequest = RecallIntentDoneRequest

class InspectIntentRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    INTENT_ID_FIELD_NUMBER: builtins.int
    intent_id: typing.Text = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"intent_id",b"intent_id"]) -> None: ...
global___InspectIntentRequest = InspectIntentRequest

class InspectIntentResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    OUTCOME_FIELD_NUMBER: builtins.int
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"outcome",b"outcome"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"outcome",b"outcome"]) -> None: ...
global___InspectIntentResponse = InspectIntentResponse
