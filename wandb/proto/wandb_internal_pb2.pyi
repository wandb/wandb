...
class Record(google.protobuf.message.Message):
    ...
    @property
    def checkpoint(self) -> global___CheckpointRecord: ...
    ...
    def __init__(self,
        *,
        ...
        checkpoint : typing.Optional[global___CheckpointRecord] = ...,
        request : typing.Optional[global___Request] = ...,
        control : typing.Optional[global___Control] = ...,
        uuid : typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"alert",b"alert",u"artifact",b"artifact",u"checkpoint",b"checkpoint",u"config",b"config",u"control",b"control",u"exit",b"exit",u"files",b"files",u"final",b"final",u"footer",b"footer",u"header",b"header",u"history",b"history",u"metric",b"metric",u"output",b"output",u"preempting",b"preempting",u"record_type",b"record_type",u"request",b"request",u"run",b"run",u"stats",b"stats",u"summary",b"summary",u"tbrecord",b"tbrecord",u"telemetry",b"telemetry"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"alert",b"alert",u"artifact",b"artifact",u"checkpoint",b"checkpoint",u"config",b"config",u"control",b"control",u"exit",b"exit",u"files",b"files",u"final",b"final",u"footer",b"footer",u"header",b"header",u"history",b"history",u"metric",b"metric",u"num",b"num",u"output",b"output",u"preempting",b"preempting",u"record_type",b"record_type",u"request",b"request",u"run",b"run",u"stats",b"stats",u"summary",b"summary",u"tbrecord",b"tbrecord",u"telemetry",b"telemetry",u"uuid",b"uuid"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"record_type",b"record_type"]) -> typing_extensions.Literal["history","summary","output","config","files","stats","artifact","tbrecord","alert","telemetry","metric","run","exit","final","header","footer","preempting","checkpoint","request"]: ...
...
class Result(google.protobuf.message.Message):
    ...
    @property
    def checkpoint_result(self) -> global___CheckpointResult: ...
    ...
    def __init__(self,
        *,
        ...
        checkpoint_result : typing.Optional[global___CheckpointResult] = ...,
        response : typing.Optional[global___Response] = ...,
        uuid : typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"checkpoint_result",b"checkpoint_result",u"config_result",b"config_result",u"exit_result",b"exit_result",u"log_result",b"log_result",u"output_result",b"output_result",u"response",b"response",u"result_type",b"result_type",u"run_result",b"run_result",u"summary_result",b"summary_result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"checkpoint_result",b"checkpoint_result",u"config_result",b"config_result",u"exit_result",b"exit_result",u"log_result",b"log_result",u"output_result",b"output_result",u"response",b"response",u"result_type",b"result_type",u"run_result",b"run_result",u"summary_result",b"summary_result",u"uuid",b"uuid"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"result_type",b"result_type"]) -> typing_extensions.Literal["run_result","exit_result","log_result","summary_result","output_result","config_result","checkpoint_result","response"]: ...
...
class RunRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"_info",b"_info",u"checkpoint",b"checkpoint",u"config",b"config",u"display_name",b"display_name",u"entity",b"entity",u"git",b"git",u"host",b"host",u"job_type",b"job_type",u"notes",b"notes",u"project",b"project",u"resumed",b"resumed",u"run_group",b"run_group",u"run_id",b"run_id",u"runtime",b"runtime",u"settings",b"settings",u"start_time",b"start_time",u"starting_step",b"starting_step",u"storage_id",b"storage_id",u"summary",b"summary",u"sweep_id",b"sweep_id",u"tags",b"tags",u"telemetry",b"telemetry"]) -> None: ...
...
class CheckpointRecord(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"_info",b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"_info",b"_info",u"name",b"name",u"overwrite",b"overwrite"]) -> None: ...
global___CheckpointRecord = CheckpointRecord

class RunKey(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"entity_name",b"entity_name",u"project_name",b"project_name",u"run_name",b"run_name"]) -> None: ...
global___RunKey = RunKey

class CheckpointResult(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    NAME_FIELD_NUMBER: builtins.int
    RUN_KEY_FIELD_NUMBER: builtins.int
    CREATED_AT_FIELD_NUMBER: builtins.int
    CONFIG_FIELD_NUMBER: builtins.int
    SUMMARY_METRICS_FIELD_NUMBER: builtins.int
    name: typing.Text = ...
    config: typing.Text = ...
    summary_metrics: typing.Text = ...

    @property
    def run_key(self) -> global___RunKey: ...
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        run_key : typing.Optional[global___RunKey] = ...,
        created_at : typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        config : typing.Text = ...,
        summary_metrics : typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"created_at",b"created_at",u"run_key",b"run_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"config",b"config",u"created_at",b"created_at",u"name",b"name",u"run_key",b"run_key",u"summary_metrics",b"summary_metrics"]) -> None: ...
global___CheckpointResult = CheckpointResult
