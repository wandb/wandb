...
class RunRecord(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"_info",b"_info",u"config",b"config",u"settings",b"settings",u"start_time",b"start_time",u"summary",b"summary",u"telemetry",b"telemetry"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"_info",b"_info",u"config",b"config",u"display_name",b"display_name",u"entity",b"entity",u"host",b"host",u"job_type",b"job_type",u"notes",b"notes",u"project",b"project",u"resumed",b"resumed",u"run_group",b"run_group",u"run_id",b"run_id",u"runqueue_item_id",b"runqueue_item_id",u"runtime",b"runtime",u"settings",b"settings",u"start_time",b"start_time",u"starting_step",b"starting_step",u"storage_id",b"storage_id",u"summary",b"summary",u"sweep_id",b"sweep_id",u"tags",b"tags",u"telemetry",b"telemetry"]) -> None: ...
