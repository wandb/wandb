...
class RunRecord(google.protobuf.message.Message):
    ...
    @property
    def lineage(self) -> global___LineageRecord: ...
    ...
    def __init__(self,
        *,
        ...
        lineage : typing.Optional[global___LineageRecord] = ...,
        _info : typing.Optional[wandb.proto.wandb_base_pb2._RecordInfo] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"_info",b"_info",u"config",b"config",u"git",b"git",u"lineage",b"lineage",u"settings",b"settings",u"start_time",b"start_time",u"summary",b"summary",u"telemetry",b"telemetry"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"_info",b"_info",u"config",b"config",u"display_name",b"display_name",u"entity",b"entity",u"git",b"git",u"host",b"host",u"job_type",b"job_type",u"lineage",b"lineage",u"notes",b"notes",u"project",b"project",u"resumed",b"resumed",u"run_group",b"run_group",u"run_id",b"run_id",u"runtime",b"runtime",u"settings",b"settings",u"start_time",b"start_time",u"starting_step",b"starting_step",u"storage_id",b"storage_id",u"summary",b"summary",u"sweep_id",b"sweep_id",u"tags",b"tags",u"telemetry",b"telemetry"]) -> None: ...
...
class ProcessRecord(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"pid",b"pid"]) -> None: ...
global___ProcessRecord = ProcessRecord

class LineageRecord(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    PROCESS_FIELD_NUMBER: builtins.int

    @property
    def process(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ProcessRecord]: ...

    def __init__(self,
        *,
        process : typing.Optional[typing.Iterable[global___ProcessRecord]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"process",b"process"]) -> None: ...
global___LineageRecord = LineageRecord
