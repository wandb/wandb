...
class RunRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"config",b"config",u"display_name",b"display_name",u"entity",b"entity",u"host",b"host",u"job_type",b"job_type",u"notes",b"notes",u"project",b"project",u"resumed",b"resumed",u"run_group",b"run_group",u"run_id",b"run_id",u"runtime",b"runtime",u"settings",b"settings",u"start_time",b"start_time",u"starting_step",b"starting_step",u"storage_id",b"storage_id",u"summary",b"summary",u"sweep_id",b"sweep_id",u"tags",b"tags",u"telemetry",b"telemetry"]) -> None: ...
...
class RunExitRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"exit_code",b"exit_code",u"runtime",b"runtime"]) -> None: ...
...
class Request(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"request_type",b"request_type"]) -> typing_extensions.Literal["stop_status","network_status","defer","get_summary","login","pause","resume","poll_exit","sampled_history","run_start","check_version","log_artifact","shutdown","attach","test_inject"]: ...
...
class AttachRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"attach_id",b"attach_id"]) -> None: ...
