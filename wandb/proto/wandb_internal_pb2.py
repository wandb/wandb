...
_TBRECORD_LOGTYPE = _descriptor.EnumDescriptor(
  name='LogType',
  full_name='wandb_internal.TBRecord.LogType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='TFEVENTS', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROFILER', index=1, number=1,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_sym_db.RegisterEnumDescriptor(_TBRECORD_LOGTYPE)
...
_TBRECORD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='log_type', full_name='wandb_internal.TBRecord.log_type', index=3,
...
_TBRECORD.fields_by_name['log_type'].enum_type = _TBRECORD_LOGTYPE
_TBRECORD_LOGTYPE.containing_type = _TBRECORD
