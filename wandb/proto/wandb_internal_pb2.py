...
_ARTIFACTRECORD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='incremental_beta1', full_name='wandb_internal.ArtifactRecord.incremental_beta1', index=14,
