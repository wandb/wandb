...
_DEBUGDATASTACK = _descriptor.Descriptor(
  name='DebugDataStack',
  full_name='wandb_internal.DebugDataStack',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='frames', full_name='wandb_internal.DebugDataStack.frames', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEBUGDATATHREAD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='stacks', full_name='wandb_internal.DebugDataThread.stacks', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEBUGPOLLRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='traceback', full_name='wandb_internal.DebugPollResponse.traceback', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='done', full_name='wandb_internal.DebugPollResponse.done', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data', full_name='wandb_internal.DebugPollResponse.data', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEBUGDATASTACK.fields_by_name['frames'].message_type = _DEBUGDATAFRAME
_DEBUGDATATHREAD.fields_by_name['stacks'].message_type = _DEBUGDATASTACK
...
DESCRIPTOR.message_types_by_name['DebugDataStack'] = _DEBUGDATASTACK
...
DebugDataStack = _reflection.GeneratedProtocolMessageType('DebugDataStack', (_message.Message,), {
  'DESCRIPTOR' : _DEBUGDATASTACK,
  '__module__' : 'wandb.proto.wandb_internal_pb2'
  # @@protoc_insertion_point(class_scope:wandb_internal.DebugDataStack)
  })
_sym_db.RegisterMessage(DebugDataStack)
