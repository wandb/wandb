...
class ServerInitSyncRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["path", b"path", "settings", b"settings"]) -> None: ...
...
class ServerSyncStatusResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["new_errors", b"new_errors", "stats", b"stats"]) -> None: ...
