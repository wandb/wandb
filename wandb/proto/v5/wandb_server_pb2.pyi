...
class ServerInformSyncRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_info", b"_info", "settings", b"settings", "sync_request", b"sync_request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_info", b"_info", "settings", b"settings", "sync_request", b"sync_request"]) -> None: ...
