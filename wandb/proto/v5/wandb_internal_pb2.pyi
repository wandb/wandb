...
class ArtifactManifest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["contents", b"contents", "manifest_file", b"manifest_file", "storage_policy", b"storage_policy", "storage_policy_config", b"storage_policy_config", "version", b"version"]) -> None: ...
