...
class ArtifactInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["artifact", b"artifact", "base_image", b"base_image", "build_context", b"build_context", "dockerfile", b"dockerfile", "entrypoint", b"entrypoint", "notebook", b"notebook"]) -> None: ...
...
class GitSource(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["base_image", b"base_image", "build_context", b"build_context", "dockerfile", b"dockerfile", "entrypoint", b"entrypoint", "git_info", b"git_info", "notebook", b"notebook"]) -> None: ...
