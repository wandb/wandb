...
if protobuf_version == "5":
    from wandb.proto.v5.wandb_system_metrics_pb2 import *
elif protobuf_version == "6":
    from wandb.proto.v6.wandb_system_metrics_pb2 import *
elif protobuf_version == "7":
    from wandb.proto.v7.wandb_system_metrics_pb2 import *
else:
    raise ImportError(
