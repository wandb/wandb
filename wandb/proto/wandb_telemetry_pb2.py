...
_FEATURE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
<<<<<<< HEAD
      name='set_run_name', full_name='wandb_internal.Feature.set_run_name', index=10,
=======
...
>>>>>>> master
    ...
    _descriptor.FieldDescriptor(
<<<<<<< HEAD
      name='set_run_id', full_name='wandb_internal.Feature.set_run_id', index=11,
=======
...
<<<<<<< HEAD
    _descriptor.FieldDescriptor(
      name='set_run_tags', full_name='wandb_internal.Feature.set_run_tags', index=12,
      number=13, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='config_wandb_init', full_name='wandb_internal.Feature.config_wandb_init', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='config_dot_set_item', full_name='wandb_internal.Feature.config_dot_set_item', index=14,
