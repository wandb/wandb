...
_TELEMETRYRECORD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='framework', full_name='wandb_internal.TelemetryRecord.framework', index=6,
...
_IMPORTS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pytorch', full_name='wandb_internal.Imports.pytorch', index=0,
