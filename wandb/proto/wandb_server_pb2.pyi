...
class ServerInformConnectRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    _INFO_FIELD_NUMBER: builtins.int
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"_info",b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"_info",b"_info"]) -> None: ...
global___ServerInformConnectRequest = ServerInformConnectRequest

class ServerInformConnectResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...

    def __init__(self,
        ) -> None: ...
global___ServerInformConnectResponse = ServerInformConnectResponse

class ServerInformListRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    _INFO_FIELD_NUMBER: builtins.int
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"_info",b"_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"_info",b"_info"]) -> None: ...
global___ServerInformListRequest = ServerInformListRequest

class ServerInformListResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    STREAMS_FIELD_NUMBER: builtins.int
    streams: google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text] = ...
...
global___ServerInformListResponse = ServerInformListResponse
...
class ServerRequest(google.protobuf.message.Message):
    ...
    INFORM_CONNECT_FIELD_NUMBER: builtins.int
    INFORM_LIST_FIELD_NUMBER: builtins.int
    ...
    @property
    def inform_connect(self) -> global___ServerInformConnectRequest: ...

    @property
    def inform_list(self) -> global___ServerInformListRequest: ...
    ...
    def __init__(self,
        *,
        ...
        inform_connect : typing.Optional[global___ServerInformConnectRequest] = ...,
        inform_list : typing.Optional[global___ServerInformListRequest] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"inform_attach",b"inform_attach",u"inform_connect",b"inform_connect",u"inform_detach",b"inform_detach",u"inform_finish",b"inform_finish",u"inform_init",b"inform_init",u"inform_list",b"inform_list",u"inform_start",b"inform_start",u"inform_teardown",b"inform_teardown",u"record_communicate",b"record_communicate",u"record_publish",b"record_publish",u"server_request_type",b"server_request_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"inform_attach",b"inform_attach",u"inform_connect",b"inform_connect",u"inform_detach",b"inform_detach",u"inform_finish",b"inform_finish",u"inform_init",b"inform_init",u"inform_list",b"inform_list",u"inform_start",b"inform_start",u"inform_teardown",b"inform_teardown",u"record_communicate",b"record_communicate",u"record_publish",b"record_publish",u"server_request_type",b"server_request_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"server_request_type",b"server_request_type"]) -> typing_extensions.Literal["record_publish","record_communicate","inform_init","inform_finish","inform_attach","inform_detach","inform_teardown","inform_start","inform_connect","inform_list"]: ...
...
class ServerResponse(google.protobuf.message.Message):
    ...
    INFORM_CONNECT_RESPONSE_FIELD_NUMBER: builtins.int
    INFORM_LIST_RESPONSE_FIELD_NUMBER: builtins.int
    ...
    @property
    def inform_connect_response(self) -> global___ServerInformConnectResponse: ...

    @property
    def inform_list_response(self) -> global___ServerInformListResponse: ...
    ...
    def __init__(self,
        *,
        ...
        inform_connect_response : typing.Optional[global___ServerInformConnectResponse] = ...,
        inform_list_response : typing.Optional[global___ServerInformListResponse] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"inform_attach_response",b"inform_attach_response",u"inform_connect_response",b"inform_connect_response",u"inform_detach_response",b"inform_detach_response",u"inform_finish_response",b"inform_finish_response",u"inform_init_response",b"inform_init_response",u"inform_list_response",b"inform_list_response",u"inform_start_response",b"inform_start_response",u"inform_teardown_response",b"inform_teardown_response",u"result_communicate",b"result_communicate",u"server_response_type",b"server_response_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"inform_attach_response",b"inform_attach_response",u"inform_connect_response",b"inform_connect_response",u"inform_detach_response",b"inform_detach_response",u"inform_finish_response",b"inform_finish_response",u"inform_init_response",b"inform_init_response",u"inform_list_response",b"inform_list_response",u"inform_start_response",b"inform_start_response",u"inform_teardown_response",b"inform_teardown_response",u"result_communicate",b"result_communicate",u"server_response_type",b"server_response_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"server_response_type",b"server_response_type"]) -> typing_extensions.Literal["result_communicate","inform_init_response","inform_finish_response","inform_attach_response","inform_detach_response","inform_teardown_response","inform_start_response","inform_connect_response","inform_list_response"]: ...
