...
class ServerRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"inform_attach",b"inform_attach",u"inform_connect",b"inform_connect",u"inform_detach",b"inform_detach",u"inform_finish",b"inform_finish",u"inform_init",b"inform_init",u"inform_start",b"inform_start",u"inform_teardown",b"inform_teardown",u"record_communicate",b"record_communicate",u"record_publish",b"record_publish",u"server_request_type",b"server_request_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"inform_attach",b"inform_attach",u"inform_connect",b"inform_connect",u"inform_detach",b"inform_detach",u"inform_finish",b"inform_finish",u"inform_init",b"inform_init",u"inform_start",b"inform_start",u"inform_teardown",b"inform_teardown",u"record_communicate",b"record_communicate",u"record_publish",b"record_publish",u"server_request_type",b"server_request_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"server_request_type",b"server_request_type"]) -> typing_extensions.Literal["record_publish","record_communicate","inform_init","inform_finish","inform_attach","inform_detach","inform_teardown","inform_start","inform_connect"]: ...
...
class ServerResponse(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"server_response_type",b"server_response_type"]) -> typing_extensions.Literal["result_communicate","inform_init_response","inform_finish_response","inform_attach_response","inform_detach_response","inform_teardown_response","inform_start_response","inform_connect_response"]: ...
