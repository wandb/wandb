...
class Feature(google___protobuf___message___Message):
    ...
    set_run_id: builtin___bool = ...
    set_run_tags: builtin___bool = ...
    config_wandb_init: builtin___bool = ...
    config_dot_set_item: builtin___bool = ...
    ...
    def __init__(self,
        *,
        ...
        set_run_id : typing___Optional[builtin___bool] = None,
        set_run_tags : typing___Optional[builtin___bool] = None,
        config_wandb_init : typing___Optional[builtin___bool] = None,
        config_dot_set_item : typing___Optional[builtin___bool] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"artifact_incremental",b"artifact_incremental",u"config_dot_set_item",b"config_dot_set_item",u"config_wandb_init",b"config_wandb_init",u"finish",b"finish",u"grpc",b"grpc",u"keras",b"keras",u"metric",b"metric",u"offline",b"offline",u"resumed",b"resumed",u"sagemaker",b"sagemaker",u"save",b"save",u"set_run_id",b"set_run_id",u"set_run_name",b"set_run_name",u"set_run_tags",b"set_run_tags",u"watch",b"watch"]) -> None: ...
