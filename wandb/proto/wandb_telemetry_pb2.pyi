...
class Labels(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    script_str: typing___Text = ...
    repo_str: typing___Text = ...
    script_version: typing___Text = ...

    @property
    def repo(self) -> type___Repos: ...

    def __init__(self,
        *,
        script_str : typing___Optional[typing___Text] = None,
        repo_str : typing___Optional[typing___Text] = None,
        repo : typing___Optional[type___Repos] = None,
        script_version : typing___Optional[typing___Text] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"repo",b"repo"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"repo",b"repo",u"repo_str",b"repo_str",u"script_str",b"script_str",u"script_version",b"script_version"]) -> None: ...
type___Labels = Labels

class Repos(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    simple_transformers: builtin___bool = ...

    def __init__(self,
        *,
        simple_transformers : typing___Optional[builtin___bool] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"simple_transformers",b"simple_transformers"]) -> None: ...
type___Repos = Repos
