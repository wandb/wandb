...
class Imports(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"allennlp",b"allennlp",u"autogluon",b"autogluon",u"autokeras",b"autokeras",u"catalyst",b"catalyst",u"catboost",b"catboost",u"deepchem",b"deepchem",u"deepctr",b"deepctr",u"fastai",b"fastai",u"flash",b"flash",u"jax",b"jax",u"keras",b"keras",u"lightgbm",b"lightgbm",u"metaflow",b"metaflow",u"mmcv",b"mmcv",u"mmdet",b"mmdet",u"optuna",b"optuna",u"pycaret",b"pycaret",u"pytorch_ignite",b"pytorch_ignite",u"pytorch_lightning",b"pytorch_lightning",u"pytorchvideo",b"pytorchvideo",u"ray",b"ray",u"recbole",b"recbole",u"simpletransformers",b"simpletransformers",u"sklearn",b"sklearn",u"skorch",b"skorch",u"spacy",b"spacy",u"tensorflow",b"tensorflow",u"torch",b"torch",u"torchdrug",b"torchdrug",u"torchtext",b"torchtext",u"torchvision",b"torchvision",u"transformers_huggingface",b"transformers_huggingface",u"xgboost",b"xgboost"]) -> None: ...
...
class Deprecated(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"keras_callback__data_type",b"keras_callback__data_type",u"plots",b"plots",u"run__join",b"run__join",u"run__mode",b"run__mode",u"run__save_no_args",b"run__save_no_args"]) -> None: ...
