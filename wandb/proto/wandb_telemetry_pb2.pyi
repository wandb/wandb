...
class Labels(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    script_id: typing___Text = ...
    repo_id: typing___Text = ...
    ...
    def __init__(self,
        *,
        script_id : typing___Optional[typing___Text] = None,
        repo_id : typing___Optional[typing___Text] = None,
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"repo",b"repo",u"repo_id",b"repo_id",u"script_id",b"script_id",u"script_version",b"script_version"]) -> None: ...
