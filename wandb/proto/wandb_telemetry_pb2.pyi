...
class Imports(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"catboost",b"catboost",u"fastai",b"fastai",u"jax",b"jax",u"keras",b"keras",u"lightgbm",b"lightgbm",u"pytorch_ignite",b"pytorch_ignite",u"pytorch_lightning",b"pytorch_lightning",u"sklearn",b"sklearn",u"tensorflow",b"tensorflow",u"torch",b"torch",u"transformers_huggingface",b"transformers_huggingface",u"xgboost",b"xgboost"]) -> None: ...
...
class Feature(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"artifact_incremental",b"artifact_incremental",u"finish",b"finish",u"grpc",b"grpc",u"keras",b"keras",u"metric",b"metric",u"offline",b"offline",u"resumed",b"resumed",u"sagemaker",b"sagemaker",u"save",b"save",u"watch",b"watch"]) -> None: ...
