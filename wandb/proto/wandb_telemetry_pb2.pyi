...
class TelemetryRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"_info",b"_info",u"cli_version",b"cli_version",u"env",b"env",u"feature",b"feature",u"huggingface_version",b"huggingface_version",u"imports_finish",b"imports_finish",u"imports_init",b"imports_init",u"label",b"label",u"process_name",b"process_name",u"python_version",b"python_version"]) -> None: ...
...
class Env(google.protobuf.message.Message):
    ...
    MULTIPROCESSING_FIELD_NUMBER: builtins.int
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"jupyter",b"jupyter",u"kaggle",b"kaggle",u"m1_gpu",b"m1_gpu",u"multiprocessing",b"multiprocessing",u"start_fork",b"start_fork",u"start_forkserver",b"start_forkserver",u"start_spawn",b"start_spawn",u"start_thread",b"start_thread",u"windows",b"windows"]) -> None: ...
global___Env = Env
