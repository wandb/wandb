...
class Feature(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"artifact_incremental",b"artifact_incremental",u"config_dot_set_item",b"config_dot_set_item",u"config_wandb_init",b"config_wandb_init",u"finish",b"finish",u"grpc",b"grpc",u"keras",b"keras",u"metaflow",b"metaflow",u"metric",b"metric",u"offline",b"offline",u"prodigy",b"prodigy",u"resumed",b"resumed",u"sagemaker",b"sagemaker",u"save",b"save",u"set_run_id",b"set_run_id",u"set_run_name",b"set_run_name",u"set_run_tags",b"set_run_tags",u"watch",b"watch"]) -> None: ...
