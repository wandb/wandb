...
class Feature(google___protobuf___message___Message):
    ...
    launch: builtin___bool = ...
    torch_profiler_trace: builtin___bool = ...
    ...
    def __init__(self,
        *,
        ...
        launch : typing___Optional[builtin___bool] = None,
        torch_profiler_trace : typing___Optional[builtin___bool] = None,
        ) -> None: ...
