...
class Imports(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"allennlp",b"allennlp",u"autogluon",b"autogluon",u"autokeras",b"autokeras",u"catalyst",b"catalyst",u"catboost",b"catboost",u"deepchem",b"deepchem",u"deepctr",b"deepctr",u"fastai",b"fastai",u"jax",b"jax",u"keras",b"keras",u"lightgbm",b"lightgbm",u"metaflow",b"metaflow",u"pycaret",b"pycaret",u"pytorch_ignite",b"pytorch_ignite",u"pytorch_lightning",b"pytorch_lightning",u"pytorchvideo",b"pytorchvideo",u"ray",b"ray",u"simpletransformers",b"simpletransformers",u"sklearn",b"sklearn",u"skorch",b"skorch",u"spacy",b"spacy",u"tensorflow",b"tensorflow",u"torch",b"torch",u"transformers_huggingface",b"transformers_huggingface",u"xgboost",b"xgboost"]) -> None: ...
