...
class Feature(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"finish",b"finish",u"grpc",b"grpc",u"incremental",b"incremental",u"keras",b"keras",u"metric",b"metric",u"offline",b"offline",u"resumed",b"resumed",u"save",b"save",u"watch",b"watch"]) -> None: ...
