...
class RunManager(object):
    ...
    def use_artifact(self, message):
        ...
        la = artifacts.ArtifactSaver(self._api, digest, server_manifest_entries, manifest, file_pusher=self._file_pusher, is_user_created=True)
    ...
    def log_artifact(self, message):
        ...
        la = artifacts.ArtifactSaver(self._api, digest, server_manifest_entries, manifest, file_pusher=self._file_pusher)
