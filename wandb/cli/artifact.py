...
@click.group(help="Commands for interacting with artifacts", name="artifact")
def artifact_cli():
    pass


@artifact_cli.command(
    context_settings={"default_map": {}}, help="Upload an artifact to wandb"
)
@click.argument("path")
@click.option(
...
@artifact_cli.command(
    context_settings={"default_map": {}}, help="Download an artifact from wandb"
)
@click.argument("path")
...
@artifact_cli.command(
    context_settings={"default_map": {}}, help="List all artifacts in a wandb project"
)
@click.argument("path")
...
@artifact_cli.group(help="Commands for interacting with the artifact cache")
def cache():
    pass
