...
@cli.command(context_settings=CONTEXT, help="Login to Weights & Biases. Use the --relogin and --host options when connecting to a W&B Server (Dedicated Cloud or Self-managed) deployment.")
@click.argument("key", nargs=-1)
@click.option("--cloud", is_flag=True, help="Login to the cloud instead of local")
@click.option("--host", default=None, help="Login to a specific instance of W&B. This is needed when connecting to a W&B Server (Dedicated Cloud or Self-managed) deployment.")
@click.option(
    "--relogin", default=None, is_flag=True, help="Force relogin if already logged in, especially when using different API keys across deployments."
)
