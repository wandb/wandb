...
from wandb._pydantic import GQLBase, GQLId, SerializedToJson
...
class GenericWebhookActionInput(GQLBase):
    integration_id: GQLId = Field(alias="integrationID")
    request_payload: Optional[SerializedToJson] = Field(
...
class UpdateFilterTriggerInput(GQLBase):
    ...
    event_filter: Optional[SerializedToJson] = Field(alias="eventFilter", default=None)
