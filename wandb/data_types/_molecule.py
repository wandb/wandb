...
class Molecule(BatchableMedia):
    ...
    def __init__(
        self,
        data_or_path: Union[str, "io.TextIO"],
        ...
        **kwargs: str,
        ...
        if hasattr(data_or_path, "read"):
            ...
            tmp_path = os.path.join(
                self._MEDIA_TMP.name, generate_id() + "." + extension
            )
    ...
    def seq_to_json(
        ...
        for obj in jsons:
            expected = to_forward_slash_path(cls.get_media_subdir())
