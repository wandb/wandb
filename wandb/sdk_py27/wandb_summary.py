...
class Summary(SummaryDict):
    ...
    __COMMENT___update_callback: t.Callable
    __COMMENT___get_current_summary_callback: t.Callable
...
class SummarySubDict(SummaryDict):
    ...
    __COMMENT___items: t.Dict
    __COMMENT___parent: SummaryDict
    __COMMENT___parent_key: str
