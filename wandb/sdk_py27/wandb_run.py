...
class Run(object):
    ...
    __COMMENT___telemetry_obj: telemetry.TelemetryRecord
    __COMMENT___teardown_hooks: List[Callable[[], None]]
    __COMMENT___tags: Optional[Tuple[Any, ...]]

    __COMMENT___entity: Optional[str]
    __COMMENT___project: Optional[str]
    __COMMENT___group: Optional[str]
    __COMMENT___job_type: Optional[str]
    __COMMENT___name: Optional[str]
    __COMMENT___notes: Optional[str]

    __COMMENT___run_obj: Optional[RunRecord]
    __COMMENT___run_obj_offline: Optional[RunRecord]
    # Use string literal anotation because of type reference loop
    __COMMENT___backend: Optional["wandb.sdk.backend.backend.Backend"]
    __COMMENT___wl: Optional[_WandbSetup]

    __COMMENT___upgraded_version_message: Optional[str]
    __COMMENT___deleted_version_message: Optional[str]
    __COMMENT___yanked_version_message: Optional[str]

    __COMMENT___out_redir: Optional[redirect.RedirectBase]
    __COMMENT___err_redir: Optional[redirect.RedirectBase]
    __COMMENT___redirect_cb: Optional[Callable[[str, str], None]]
    __COMMENT___output_writer: Optional["WriteSerializingFile"]

    __COMMENT___atexit_cleanup_called: bool
    __COMMENT___hooks: Optional[ExitHooks]
    __COMMENT___exit_code: Optional[int]

    __COMMENT___run_status_checker: Optional[RunStatusChecker]
    __COMMENT___poll_exit_response: Optional[PollExitResponse]

    __COMMENT___sampled_history: Optional[Dict[str, Union[List[int], List[float]]]]

    __COMMENT___use_redirect: bool
    __COMMENT___stdout_slave_fd: Optional[int]
    __COMMENT___stderr_slave_fd: Optional[int]
    ...
    def _redirect(
        ...
        __COMMENT__out_redir: redirect.RedirectBase
        __COMMENT__err_redir: redirect.RedirectBase
