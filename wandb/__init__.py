...
watch = _preinit.PreInitCallable("wandb.log", wandb_sdk.wandb_run.Run.watch)  # type: ignore
unwatch = _preinit.PreInitCallable("wandb.log", wandb_sdk.wandb_run.Run.unwatch)  # type: ignore
