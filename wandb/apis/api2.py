...
class Entity(object):
    ...
    def projects(self):
        return Projects(client=self.client, entity=self)
...
class Project(Attrs):
    ...
    def __init__(self, client, entity, name, attrs=None):
        attrs = attrs or {}
    ...
    def runs(self, filter=None, order="-created_at"):
    ...
    def delete_run(self, run_id, delete_artifacts=False):
    ...
    def get_expected_artifact_type(self, artifact_name):
...
class Runs(Paginator):
    ...
    def __init__(
        self, client, project, sweep_id=None, filters=None, order=None, per_page=50
    ):
...
class Sweep(Attrs):
    ...
    def __init__(self, client, project, sweep_id, attrs=None):
    ...
    def runs(self, filters=None, order=None):
        if order is None:
            order = self.order
        return Runs(
            client=self.client,
...
class Run(Attrs):
    ...
    def __init__(self, client, entity=None, project=None, run_id=None, attrs=None):
        """
...
class ArtifactType(Attrs):
    def __init__(self, client, project, type_name, attrs=None):
...
class ProjectArtifactTypes(Paginator):
    ...
    def __init__(self, client, project, name=None, per_page=50):
        self.entity = project.entity
        self.project = project
...
class ArtifactCollection(Attrs):
    def __init__(self, client, project, name, type, attrs=None):
...
class ProjectArtifactCollections(Paginator):
    ...
    def __init__(self, client, project, type_name, per_page=50):
        self.entity = project.entity
        self.project = project
...
class Artifact(artifacts.Artifact):
    ...
    def __init__(self, client, project, name, attrs=None):
        self.client = client
        self.entity = project.entity
        self.project = project
...
class ReportSection(Attrs):
    ...
    def runs(self, per_page=50, only_selected=True):
...
class Reports(Paginator):
    ...
    def __init__(self, client, project, names=None, per_page=50):
        self.project = project
        self.entity = project.entity
        self.names = names
        variables = {
