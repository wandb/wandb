...
def get_view(entity: str, project: str, view_name: str) -> View:
    response = _get_view(entity, project, view_name)

    spec = response["project"]["allViews"]["edges"][0]["node"]["spec"]
    display_name = response["project"]["allViews"]["edges"][0]["node"]["displayName"]
    id = response["project"]["allViews"]["edges"][0]["node"]["id"]
