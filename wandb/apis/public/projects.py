...
class Project(Attrs):
    ...
    @property
    def id(self) -> str:
        # NOTE: This is a workaround to ensure that the project ID can be
        #  retrieved on-demand, even if not set by default on instantiation.
        #  Necessary if using this project to define the scope of a new automation.
