...
class Run(Attrs):
    ...
    def log_artifact(self, artifact, aliases=None):
        ...
        if self.entity != artifact.source_entity:
            raise ValueError("A run can't log an artifact to a different entity.")
        if self.project != artifact.source_project:
            raise ValueError("A run can't log an artifact from a different project.")
