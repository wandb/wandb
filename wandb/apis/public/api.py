...
from wandb.apis.public._query_compat import SchemaInfo
...
class Api:
    ...
    def create_automation(
        ...
        **updates: Unpack[AutomationParams],
        ...
        """
        from ._query_compat import gql_compat
        ...
        mutation = gql_compat(CREATE_FILTER_TRIGGER_GQL, self.client.schema_info)
