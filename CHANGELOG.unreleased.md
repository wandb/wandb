...
- Kubeflow Pipelines v2 (kfp>=2.0.0) support for the `@wandb_log` decorator. The integration automatically detects the installed KFP version and logs component inputs/outputs to W&B. (Fixes WB-30290)
