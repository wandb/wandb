...
- When a run function called by Sweeps API throws an exception, we will now log that exception server-side. (@kelu-wandb in https://github.com/wandb/wandb/pull/10244)
