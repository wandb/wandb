...
- Listing automations keeps other items on the page when the server returns an action, event, or scope type this SDK version does not model (`SavedUnknownAction`, `SavedUnknownEvent`). (@gdecarvalhovaz-lgtm in https://github.com/wandb/wandb/pull/12595)
