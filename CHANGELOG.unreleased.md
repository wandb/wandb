...
### Added
- New `sweep_id` parameter to `Api().create_run()` and `Run().create()` that manually creates a run as part of the sweep (@kmikowicz-wandb in https://github.com/wandb/wandb/pull/12223)
