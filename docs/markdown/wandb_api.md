...
## Api
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L137)
```python
Api(self, overrides={})
```
...
### Api.flush
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L207)
```python
Api.flush(self)
```
...
## Projects
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L497)
```python
...
## Project
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L553)
```python
...
### Project.artifacts
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L569)
```python
...
## Run
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L667)
```python
...
### Run.create
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L749)
```python
...
### Run.update
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L831)
```python
Run.update(self)
```
...
### Run.files
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L890)
```python
...
### Run.file
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L902)
```python
Run.file(self, name)
```
...
### Run.history
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L913)
```python
Run.history(self,
            samples=500,
            keys=None,
...
## Sweep
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1024)
```python
...
### Sweep.best_run
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1105)
```python
...
### Sweep.get
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1125)
```python
Sweep.get(client,
          entity=None,
          project=None,
...
## Files
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1165)
```python
...
## File
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1221)
```python
...
### File.download
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1268)
```python
...
## Reports
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1299)
```python
...
## QueryGenerator
[source](https://github.com/wandb/client/blob/master/wandb/apis/public.py#L1364)
```python
QueryGenerator(self)
```
