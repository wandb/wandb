...
## Graph
[source](https://github.com/wandb/client/blob/master/wandb/data_types.py#L1155)
```python
...
## Node
[source](https://github.com/wandb/client/blob/master/wandb/data_types.py#L1310)
```python
Node(self,
     id=None,
     name=None,
...
## Edge
[source](https://github.com/wandb/client/blob/master/wandb/data_types.py#L1475)
```python
...
[source](https://github.com/wandb/client/blob/master/wandb/data_types.py#L1600)
```python
