# TODO(experimental-py): this file is copied with changes from main hatch_build.sh
import dataclasses
import os
import pathlib
import platform
...
class CustomBuildHook(BuildHookInterface):
    ...
    # TODO(experimental-py): this shouldnt be here as it isnt in the normal hatch_build anymore
    ...
    def _build_wandb_core(self) -> List[str]:
        # TODO(experimental-py): hack directory locations
        current_dir = pathlib.Path.cwd()
