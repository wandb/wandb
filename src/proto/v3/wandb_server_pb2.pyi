...
class ServerRequest(google.protobuf.message.Message):
    ...
    @property
    def record_publish(self) -> src.proto.wandb_internal_pb2.Record: ...
    @property
    def record_communicate(self) -> src.proto.wandb_internal_pb2.Record: ...
    @property
    ...
    def __init__(
        self,
        *,
        record_publish: src.proto.wandb_internal_pb2.Record | None = ...,
        record_communicate: src.proto.wandb_internal_pb2.Record | None = ...,
...
class ServerResponse(google.protobuf.message.Message):
    ...
    @property
    def result_communicate(self) -> src.proto.wandb_internal_pb2.Result: ...
    @property
    ...
    def __init__(
        self,
        *,
        result_communicate: src.proto.wandb_internal_pb2.Result | None = ...,
