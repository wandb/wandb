...
func (x *Record) GetHistoryz() *HistoryRecord {
	if x, ok := x.GetRecordType().(*Record_Historyz); ok {
		return x.Historyz
	}
	return nil
}
...
type Record_Historyz struct {
	// Low numbers for more frequent data
	Historyz *HistoryRecord `protobuf:"bytes,2,opt,name=historyz,proto3,oneof"`
}
...
func (*Record_Historyz) isRecord_RecordType() {}
...
var file_wandb_proto_wandb_internal_proto_rawDesc = []byte{
	...
	0x6d, 0x12, 0x3b, 0x0a, 0x08, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x7a, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x77, 0x61, 0x6e, 0x64, 0x62, 0x5f, 0x69, 0x6e, 0x74, 0x65,
	0x72, 0x6e, 0x61, 0x6c, 0x2e, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x48, 0x00, 0x52, 0x08, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x7a, 0x12, 0x39,
	...
	0x2e, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x48, 0x00,
	0x52, 0x07, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x12, 0x36, 0x0a, 0x06, 0x6f, 0x75, 0x74,
...
var file_wandb_proto_wandb_internal_proto_depIdxs = []int32{
	24,  // 0: wandb_internal.Record.historyz:type_name -> wandb_internal.HistoryRecord
