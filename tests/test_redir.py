...
def test_basic(cls, capsys, capfd):
...
@pytest.mark.parametrize("cls", impls)
def test_reinstall(cls, capsys, capfd):
    with capsys.disabled():
        with capfd.disabled():
            o1, o2 = [], []
...
@pytest.mark.parametrize("cls", impls)
def test_tqdm_progbar(cls, capsys, capfd):
    with capsys.disabled():
        with capfd.disabled():
            o = []
...
@pytest.mark.parametrize("cls", impls)
def test_formatting(cls, capsys, capfd):
    with capsys.disabled():
        with capfd.disabled():
            o = []
...
@pytest.mark.parametrize("cls", impls)
def test_interactive(cls, capsys, capfd):
    with capsys.disabled():
        with capfd.disabled():
...
@pytest.mark.parametrize("cls", impls)
def test_keras_progbar(cls, capsys, capfd):
    with capsys.disabled():
        with capfd.disabled():
            o = []
