...
def test_agent_is_singleton(mocker, agent_common_setup, fresh_agent):
    config = {
        "entity": "test-entity",
...
@pytest.mark.asyncio
@pytest.mark.skip
def test_agent_basic_loop(mocker, agent_common_setup, fresh_agent):
    pass
