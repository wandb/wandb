...
@pytest.mark.parametrize("resume", ("never", "must", "allow", "auto"))
...
@pytest.mark.parametrize("resume", ("must", "never", "allow", "auto", True))
def test_resume__offline__accepts_all_modes(resume):
