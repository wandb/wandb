...
pub struct Settings {
    ...
    pub file_stream_max_bytes: ::core::option::Option<i32>,
    /// Interval in seconds between filestream transmissions.
    #[prost(message, optional, tag = "175")]
    pub file_stream_transmit_interval: ::core::option::Option<f64>,
    ...
    pub require_legacy_service: ::core::option::Option<bool>,
    ...
    pub stats_sampling_interval: ::core::option::Option<f64>,
