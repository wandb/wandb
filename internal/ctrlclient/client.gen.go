// Package ctrlclient provides primitives to interact with the openapi HTTP API.
//
...
type ClientInterface interface {
	...
	CreateReleaseChannelWithBody(ctx context.Context, deploymentId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateReleaseChannel(ctx context.Context, deploymentId string, body CreateReleaseChannelJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) CreateReleaseChannelWithBody(ctx context.Context, deploymentId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateReleaseChannelRequestWithBody(c.Server, deploymentId, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *Client) CreateReleaseChannel(ctx context.Context, deploymentId string, body CreateReleaseChannelJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateReleaseChannelRequest(c.Server, deploymentId, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewCreateReleaseChannelRequest(server string, deploymentId string, body CreateReleaseChannelJSONRequestBody) (*http.Request, error) {
	...
	return NewCreateReleaseChannelRequestWithBody(server, deploymentId, "application/json", bodyReader)
}

// NewCreateReleaseChannelRequestWithBody generates requests for CreateReleaseChannel with any type of body
func NewCreateReleaseChannelRequestWithBody(server string, deploymentId string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/deployments/%s/release-channels", pathParam0)
	if operationPath[0] == '/' {
...
type ClientWithResponsesInterface interface {
	...
	CreateReleaseChannelWithBodyWithResponse(ctx context.Context, deploymentId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateReleaseChannelResponse, error)

	CreateReleaseChannelWithResponse(ctx context.Context, deploymentId string, body CreateReleaseChannelJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateReleaseChannelResponse, error)
...
func (c *ClientWithResponses) CreateReleaseChannelWithBodyWithResponse(ctx context.Context, deploymentId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateReleaseChannelResponse, error) {
	rsp, err := c.CreateReleaseChannelWithBody(ctx, deploymentId, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateReleaseChannelWithResponse(ctx context.Context, deploymentId string, body CreateReleaseChannelJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateReleaseChannelResponse, error) {
	rsp, err := c.CreateReleaseChannel(ctx, deploymentId, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateReleaseChannelResponse(rsp)
