...
* Added feature to delete staging files for mutable artifact file uploads synchronously when caching is enabled by @ibindlish in https://github.com/wandb/wandb/pull/7143
