...
* feat(sweeps): Adds Sweep.expected_run_count to public Api by @gtarpenning in https://github.com/wandb/wandb/pull/4434
...
* feat(sdk): Improvements to Report API in preparation for GA by @andrewtruong in https://github.com/wandb/wandb/pull/4499
### :hammer: Fixes
* fix(artifacts): have default artifactVersions only retrieve committed artifacts by @estellazx in https://github.com/wandb/wandb/pull/4401
* fix(cli): Deflake wandb verify by @vanpelt in https://github.com/wandb/wandb/pull/4438
* fix(launch): Fix LaunchProject override_arg format when setb from Job by @KyleGoyette in https://github.com/wandb/wandb/pull/4416
...
* fix(sdk): pin tensorflow<2.11.0 to prevent errors caused by API changes by @moredatarequired in https://github.com/wandb/wandb/pull/4508
* fix(public-api): Changed `artifactSequence` to `artifactCollection` in public GQL requests by @tssweeney in https://github.com/wandb/wandb/pull/4531
* fix(integrations): TF compatibility issues with WandbModelCheckpoint by @soumik12345 in https://github.com/wandb/wandb/pull/4432
...
### :gear: Dev
* build(sdk): bump SDK version to latest dev version by @raubitsj in https://github.com/wandb/wandb/pull/4436
...
* test(artifacts): skip flaky test :( by @speezepearson in https://github.com/wandb/wandb/pull/4463
* test(artifacts): flush writes instead of sleeping to wait on file writes by @moredatarequired in https://github.com/wandb/wandb/pull/4523
...
* test(artifacts): skip mysteriously flaky test by @speezepearson in https://github.com/wandb/wandb/pull/4550
* test(sdk): add many tests for InternalApi.upload_file by @speezepearson in https://github.com/wandb/wandb/pull/4539
* chore(artifacts): Artifact Sequence Fallbacks by @tssweeney in https://github.com/wandb/wandb/pull/4565
...
* refactor(artifacts): Re-add programmatic alias addition/removal from SDK on artifacts by @vwrj in https://github.com/wandb/wandb/pull/4429
...
* feat(launch): Creates a `--build` flag for building then pushing the image to a queue by @gtarpenning in https://github.com/wandb/wandb/pull/4061
