...
- Restored compatibility for macOS versions <= 10.15 in our Python package. This fix resolves issues related to running wandb-core on older macOS versions. (@dmitryduev in https://github.com/wandb/wandb/pull/8487)
