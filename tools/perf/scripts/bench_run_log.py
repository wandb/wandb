...
class PayloadGenerator:
    ...
    def __init__(
        self,
        data_type: Literal["scalar", "audio", "table", "image", "video"],
        metric_count: int,
        metric_key_size: int,
    ):
...
class Experiment:
    ...
    def __init__(
        ...
        data_type: Literal["scalar", "audio", "table", "image", "video"] = "scalar",
    ):
    ...
    def single_run(self):
        ...
        with Timer() as timer:
            run = wandb.init(
                project="perf-test",
                name=f"perf_run={start_time_str}_steps={self.num_steps}"
                    f"_metrics={self.num_metrics}_datatype={self.data_type}",
                config=result_data,
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--data-type",
        type=str,
        choices=["scalar", "audio", "table", "image", "video"],
        default="scalar",
